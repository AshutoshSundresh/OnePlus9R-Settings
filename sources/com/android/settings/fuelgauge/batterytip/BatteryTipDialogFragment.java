    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (type == 1) {
            ...
            if (size == 1) {
                ...
                RecyclerView recyclerView = (RecyclerView) LayoutInflater.from(context).inflate(C0012R$layout.op_recycler_view, (ViewGroup) null);
            ...
            RecyclerView recyclerView2 = (RecyclerView) LayoutInflater.from(context).inflate(C0012R$layout.op_recycler_view, (ViewGroup) null);
            ...
            builder2.setView(recyclerView2);
            builder2.setPositiveButton(17039370, (DialogInterface.OnClickListener) null);
            return builder2.create();
        } else if (type == 6) {
            AlertDialog.Builder builder3 = new AlertDialog.Builder(context);
            builder3.setMessage(C0017R$string.battery_tip_dialog_summary_message);
