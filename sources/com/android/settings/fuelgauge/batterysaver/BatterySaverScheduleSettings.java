...
public class BatterySaverScheduleSettings extends RadioButtonPickerFragment {
    ...
    public List<? extends CandidateInfo> getCandidates() {
        ...
        newArrayList.add(new BatterySaverScheduleCandidateInfo(context.getText(C0017R$string.no_notification_assistant), null, "key_battery_saver_no_schedule", true));
