...
public class WallpaperAttributionsPreferenceController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        } else if (OPUtils.isEightSeriesProducts() || OPUtils.isLProducts()) {
            if (OPThemeUtils.isSupportREDTheme()) {
                this.mPreference.setSummary(this.mContext.getString(C0017R$string.oneplus_wallpaper_attributions_8250_R_values) + this.mContext.getString(C0017R$string.oneplus_wallpaper_attributions_red_values));
            } else {
                this.mPreference.setSummary(C0017R$string.oneplus_wallpaper_attributions_8250_R_values);
            }
        } else if (OPUtils.isAviciiProducts()) {
            this.mPreference.setSummary(C0017R$string.oneplus_wallpaper_attributions_7250_values);
        } else {
            this.mPreference.setSummary(C0017R$string.oneplus_wallpaper_attributions_values);
        }
