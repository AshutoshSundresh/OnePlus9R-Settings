...
public class MediaOutputPanel implements PanelContent, LocalMediaManager.DeviceCallback, LifecycleObserver {
    ...
    public IconCompat getIcon() {
        ...
        return IconCompat.createWithBitmap(com.android.settings.Utils.convertCornerRadiusBitmap(context, iconBitmap, (float) context.getResources().getDimensionPixelSize(C0007R$dimen.output_switcher_panel_icon_corner_radius)));
    }
