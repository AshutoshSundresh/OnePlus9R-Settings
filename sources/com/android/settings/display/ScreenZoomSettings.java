...
public class ScreenZoomSettings extends PreviewSeekBarPreferenceFragment {
    ...
    public int getActivityLayoutResId() {
        return C0012R$layout.op_screen_zoom_activity;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (new DisplayDensityUtils(getContext()).getCurrentIndex() < 0) {
            ...
            this.mDefaultDensity = oPDisplayDensityUtils.getDefaultDensity(getContext());
        }
    ...
    public void commit() {
        ...
        if (i == this.mDefaultDensity) {
            int i2 = Settings.Global.getInt(getContext().getContentResolver(), "oneplus_screen_resolution_adjust", 2);
            if (i2 == 0 || i2 == 2) {
