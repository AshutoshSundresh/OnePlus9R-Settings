...
public class DarkModeSettingsFragment extends DashboardFragment {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        if (OPThemeUtils.isSupportREDTheme()) {
            ...
            preference.setLayoutResource(C0012R$layout.op_preference_summary);
            preference.setSelectable(false);
            preference.setTitle(C0017R$string.op_red_theme_dark_mode_tips);
            preference.setOrder(-80);
            getPreferenceScreen().addPreference(preference);
            Preference findPreference = findPreference("dark_mode_enabled");
            if (findPreference != null) {
                findPreference.setEnabled(!OPThemeUtils.isCurrentREDTheme(getContext()));
            }
        }
    }
