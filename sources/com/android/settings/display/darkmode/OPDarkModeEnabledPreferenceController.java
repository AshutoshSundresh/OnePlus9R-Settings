...
public class OPDarkModeEnabledPreferenceController extends TogglePreferenceController {
    ...
    public boolean setChecked(final boolean z) {
        ...
        new Handler().postDelayed(new Runnable() {
            /* class com.android.settings.display.darkmode.OPDarkModeEnabledPreferenceController.AnonymousClass1 */

            public void run() {
                OPDarkModeEnabledPreferenceController.this.enableDarkMode(z);
            }
        }, 300);
        return true;
    }
    ...
    public void enableDarkMode(boolean z) {
        boolean z2 = (this.mContext.getResources().getConfiguration().uiMode & 32) != 0 ? 1 : 0;
        String str = z2 ? "0" : "1";
        Settings.System.putInt(this.mContext.getContentResolver(), "oem_black_mode", !z2);
