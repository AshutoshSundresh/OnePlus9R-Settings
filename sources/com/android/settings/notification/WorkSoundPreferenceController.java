        ...
        if (this.mWorkPreferenceCategory != null) {
            ...
            if (isAvailable) {
                ...
                if (this.mWorkAlarmRingtonePreference == null) {
                    DefaultRingtonePreference initWorkPreference = initWorkPreference(this.mWorkPreferenceCategory, "work_alarm_ringtone");
                    this.mWorkAlarmRingtonePreference = initWorkPreference;
                    initWorkPreference.setVisible(false);
                }
