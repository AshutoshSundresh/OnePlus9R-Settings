...
public class SoundSettings extends DashboardFragment implements OnActivityResultListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0019R$xml.sound_settings) {
        ...
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean z) {
            ...
            if (OPUtils.isAviciiProducts() && oPDolbyAtmosControlPreferenceController.isAvailable()) {
                SearchIndexableRaw searchIndexableRaw = new SearchIndexableRaw(context);
                searchIndexableRaw.title = context.getString(C0017R$string.oneplus_dirac_audio_tuner);
                ((SearchIndexableData) searchIndexableRaw).key = "dirac_audio_tuner";
                searchIndexableRaw.screenTitle = context.getString(C0017R$string.oneplus_sound_and_vibrate);
