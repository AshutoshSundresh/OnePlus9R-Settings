...
public class ZenCustomRuleCallsSettings extends ZenCustomRuleSettingsBase {
    ...
    public List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        ...
        ((ZenCustomRuleSettingsBase) this).mControllers.add(new ZenRuleRepeatCallersPreferenceController(context, "zen_mode_repeat_callers", getSettingsLifecycle(), context.getResources().getInteger(17694935)));
