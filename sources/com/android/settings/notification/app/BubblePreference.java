...
public class BubblePreference extends Preference implements View.OnClickListener {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        ButtonViewHolder buttonViewHolder = new ButtonViewHolder(this, findViewById2, (ImageView) preferenceViewHolder.findViewById(R$id.bubble_all_icon), (TextView) preferenceViewHolder.findViewById(R$id.bubble_all_label), 1);
        ...
        ButtonViewHolder buttonViewHolder2 = new ButtonViewHolder(this, findViewById3, (ImageView) preferenceViewHolder.findViewById(R$id.bubble_selected_icon), (TextView) preferenceViewHolder.findViewById(R$id.bubble_selected_label), 2);
        ...
        ButtonViewHolder buttonViewHolder3 = new ButtonViewHolder(this, findViewById4, (ImageView) preferenceViewHolder.findViewById(R$id.bubble_none_icon), (TextView) preferenceViewHolder.findViewById(R$id.bubble_none_label), 0);
    ...
    private class ButtonViewHolder {
        ...
        ButtonViewHolder(BubblePreference bubblePreference, View view, ImageView imageView, TextView textView, int i) {
            this.mView = view;
        ...
        public void setSelected(Context context, boolean z) {
            ...
            this.mView.setBackgroundResource(z ? R$drawable.button_border_selected : R$drawable.button_border_unselected);
