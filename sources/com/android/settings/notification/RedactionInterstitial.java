...
public class RedactionInterstitial extends SettingsActivity {
    ...
    public static class RedactionInterstitialFragment extends SettingsPreferenceFragment implements RadioGroup.OnCheckedChangeListener {
        ...
        public void onDoneButtonClicked(View view) {
            boolean booleanExtra = (getIntent() == null || !getIntent().hasExtra("extra_from_setup_wizard")) ? false : getIntent().getBooleanExtra("extra_from_setup_wizard", false);
            Log.d("RedactionInterstitial", "onDoneButtonClicked is from setup wizard = " + booleanExtra);
            if (!booleanExtra) {
                Log.d("RedactionInterstitial", "set RedactionInterstitial disable.");
