...
public class ResetNetwork extends InstrumentedFragment {
    ...
    View mEsimContainer;
    private TextView mInitiateButton;
    ...
    private void establishInitialState() {
        ...
        TextView textView = (TextView) this.mContentView.findViewById(C0010R$id.initiate_reset_network);
        this.mInitiateButton = textView;
        textView.setOnClickListener(this.mInitiateListener);
