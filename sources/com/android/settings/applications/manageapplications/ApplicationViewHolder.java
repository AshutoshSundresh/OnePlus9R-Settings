...
public class ApplicationViewHolder extends RecyclerView.ViewHolder {
    ...
    ApplicationViewHolder(View view) {
        ...
        this.mCheckBox = (CheckBox) view.findViewById(C0010R$id.checkbox);
        this.mDivider = view.findViewById(C0010R$id.two_target_divider);
    }

    static View newViewForVzw(ViewGroup viewGroup) {
        Log.d("ApplicationViewHolder", "newViewForVzw");
        ...
        if (viewGroup3 != null) {
            LayoutInflater.from(viewGroup.getContext()).inflate(C0012R$layout.preference_widget_checkbox_uninstall_apps, viewGroup3, true);
        }
        return viewGroup2;
    }
    ...
    /* access modifiers changed from: package-private */
    public void showWidgetContainer() {
    ...
    public void updateSwitch(View.OnClickListener onClickListener, boolean z, boolean z2) {
        ...
        } else if (this.mCheckBox != null && this.mWidgetContainer != null) {
            Log.d("ApplicationViewHolder", "updateSwitch: Checkbox");
