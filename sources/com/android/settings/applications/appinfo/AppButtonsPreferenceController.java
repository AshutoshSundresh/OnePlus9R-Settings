...
public class AppButtonsPreferenceController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnResume, OnDestroy, ApplicationsState.Callbacks {
    ...
    private static final String PACKAGENAME_ECHOLOCATE = "com.tmobile.echolocate";
    ...
    public void updateUninstallButton() {
        ...
        if (context != null) {
            if (TextUtils.equals(context.getString(C0017R$string.oneplus_cannot_disable_package_1), this.mAppEntry.info.packageName) || TextUtils.equals(this.mContext.getString(C0017R$string.oneplus_cannot_disable_package_2), this.mAppEntry.info.packageName) || TextUtils.equals(this.mContext.getString(C0017R$string.oneplus_cannot_disable_package_3), this.mAppEntry.info.packageName)) {
                z = false;
            }
    ...
    public void updateForceStopButton() {
        if (this.mDpm.packageHasActiveAdmins(this.mPackageInfo.packageName)) {
            ...
            updateForceStopButtonInner(LOCAL_LOGV);
        } else if (!OPUtils.isSupportUstMode() || !PACKAGENAME_ECHOLOCATE.equals(this.mPackageInfo.packageName)) {
