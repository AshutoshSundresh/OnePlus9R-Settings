...
public class AppOpenByDefaultPreferenceController extends AppInfoPreferenceControllerBase {
    ...
    public void updateState(Preference preference) {
        ...
        if (this.mParent.getAppEntry() == null || packageInfo == null || AppUtils.isInstant(packageInfo.applicationInfo) || AppUtils.isBrowserApp(this.mContext, packageInfo.packageName, UserHandle.myUserId())) {
