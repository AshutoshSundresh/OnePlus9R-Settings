...
public class AppInfoDashboardFragment extends DashboardFragment implements ApplicationsState.Callbacks, ButtonActionDialogFragment.AppButtonsDialogListener {
    ...
    BroadcastReceiver mPackageRemovedReceiver = new BroadcastReceiver() {
    ...
    private TimeSpentInAppPreferenceController timeSpentInAppPreferenceController;
    ...
    public void onDetach() {
        super.onDetach();
        TimeSpentInAppPreferenceController timeSpentInAppPreferenceController2 = this.timeSpentInAppPreferenceController;
        if (timeSpentInAppPreferenceController2 != null) {
            timeSpentInAppPreferenceController2.removeLifeCycleOwner();
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        TimeSpentInAppPreferenceController timeSpentInAppPreferenceController2 = (TimeSpentInAppPreferenceController) use(TimeSpentInAppPreferenceController.class);
        this.timeSpentInAppPreferenceController = timeSpentInAppPreferenceController2;
        timeSpentInAppPreferenceController2.setPackageName(packageName);
        this.timeSpentInAppPreferenceController.initLifeCycleOwner(this);
