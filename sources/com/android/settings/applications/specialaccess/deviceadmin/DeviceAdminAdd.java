...
public class DeviceAdminAdd extends BaseActivity {
    ...
    public void updateInterface() {
        ...
        setTitle(this.mDeviceAdmin.loadLabel(getPackageManager()));
    }
    ...
    private void addDeviceAdminPolicies(boolean z) {
        if (!this.mAdminPoliciesInitialized) {
            ...
            while (it.hasNext()) {
                ...
                int i = isAdminUser ? policyInfo.description : policyInfo.descriptionForSecondaryUsers;
                int i2 = isAdminUser ? policyInfo.label : policyInfo.labelForSecondaryUsers;
                ...
                textView.setTextColor(getResources().getColor(C0006R$color.op_control_text_color_secondary));
                textView.setText(getText(i2));
                linearLayout.addView(textView);
                if (z) {
                    TextView textView2 = new TextView(this);
                    textView2.setTextAppearance(C0018R$style.oneplus_contorl_text_style_body1);
                    textView2.setTextColor(getResources().getColor(C0006R$color.op_control_text_color_secondary));
                    textView2.setText(getText(i));
                    linearLayout.addView(textView2);
                }
                this.mAdminPolicies.addView(linearLayout);
            }
