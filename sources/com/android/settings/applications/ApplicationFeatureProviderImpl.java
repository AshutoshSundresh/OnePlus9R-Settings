...
public class ApplicationFeatureProviderImpl implements ApplicationFeatureProvider {
    ...
    public Set<String> getKeepEnabledPackages() {
        ...
        if (isPackageInstalled("com.google.android.apps.setupwizard.searchselector")) {
    ...
    private Set<String> getEnabledPackageWhitelist() {
        ...
        arraySet.add(this.mContext.getString(C0017R$string.config_google_package_installer_package_name));
        return arraySet;
    }
