...
public abstract class AppInfoBase extends SettingsPreferenceFragment implements ApplicationsState.Callbacks {
    ...
    public static CharSequence getSummaryByDate(Context context, ApplicationsState.AppEntry appEntry) {
        return new SimpleDateFormat("dd/MM/yyyy HH:mm a").format(Long.valueOf(appEntry.apkUpdateTimestamp));
    }
    ...
    public static CharSequence getSummary(Context context, String str) {
        ...
        if (ProductUtils.isUsvMode() && AppBgOptimizeBridge.VZW_APPS_SHOWN_DISABLED.contains(str)) {
