...
public abstract class ConfirmDeviceCredentialBaseFragment extends InstrumentedFragment {
    ...
    private final Runnable mResetErrorRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (!confirmDeviceCredentialBaseFragment.isLockedOutStage) {
                confirmDeviceCredentialBaseFragment.mErrorTextView.setText("");
            }
        }
    };
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (glifLayout != null && glifLayout.shouldApplyPartnerResource()) {
            IconMixin iconMixin = (IconMixin) glifLayout.getMixin(IconMixin.class);
            if (iconMixin != null) {
                iconMixin.setIconTint(getResources().getColor(C0006R$color.op_setupwizard_oxygen_accent_color));
            }
            if (getActivity() != null) {
