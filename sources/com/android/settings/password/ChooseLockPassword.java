...
public class ChooseLockPassword extends SettingsActivity {
    ...
    public static class ChooseLockPasswordFragment extends InstrumentedFragment implements TextView.OnEditorActionListener, TextWatcher, SaveChosenLockWorkerBase.Listener {
        ...
        protected GlifLayout mLayout;
        private LockPatternUtils mLockPatternUtils;
        private TextView mMessage;
        private int mMinComplexity = 0;
        private PasswordMetrics mMinMetrics;
        private FooterButton mNextButton;
        protected ImeAwareEditText mPasswordEntry;
        private TextViewInputDisabler mPasswordEntryInputDisabler;
        private byte[] mPasswordHistoryHashFactor;
        protected PasswordRequirementAdapter mPasswordRequirementAdapter;
            ...
            if (this.mSaveAndFinishWorker == null) {
                ...
                if (!TextUtils.isEmpty(text)) {
                    ...
                    if (stage == Stage.Introduction) {
                        ...
                        } else if (validateLocal(text.toString())) {
        ...
        public void updateUi() {
            ...
            boolean z = true;
            boolean z2 = false;
            boolean z3 = this.mSaveAndFinishWorker == null;
            if (this.mIsAlphaMode) {
            ...
            if (this.mUiStage == Stage.Introduction) {
                ...
                if (TextUtils.isEmpty(obj) || validateLocal(obj)) {
                    z2 = validatePassword;
                } else {
                    this.mValidationErrors = Collections.singletonList(new PasswordValidationError(2));
                }
