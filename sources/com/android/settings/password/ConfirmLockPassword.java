...
public class ConfirmLockPassword extends ConfirmDeviceCredentialBaseActivity {
    ...
    public static class ConfirmLockPasswordFragment extends ConfirmDeviceCredentialBaseFragment implements View.OnClickListener, TextView.OnEditorActionListener, CredentialCheckResultTracker.Listener {
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            ...
            if (getActivity() != null && WizardManagerHelper.isAnySetupWizard(getActivity().getIntent())) {
        ...
        public void startEnterAnimation() {
            ...
            this.mAppearAnimationUtils.startAnimation(getActiveViews(), new Runnable() {
                ...
                public final void run() {
                    ConfirmLockPassword.ConfirmLockPasswordFragment.this.lambda$handleAttemptLockout$1();
                }
            });
        }
        ...
        /* renamed from: updatePasswordEntry */
        public void lambda$handleAttemptLockout$1() {
            ...
            this.mCountdownTimer = new CountDownTimer(j - SystemClock.elapsedRealtime(), 1000) {
                ...
                public void onFinish() {
                    ThreadUtils.postOnMainThread(new Runnable() {
                        /* class com.android.settings.password.$$Lambda$ConfirmLockPassword$ConfirmLockPasswordFragment$3$JGs4dyZmOqWs6GM6vyHFP8bsSS0 */

                        public final void run() {
                            ConfirmLockPassword.ConfirmLockPasswordFragment.AnonymousClass3.this.lambda$onFinish$0$ConfirmLockPassword$ConfirmLockPasswordFragment$3();
                        }
                    });
                    ConfirmLockPasswordFragment.this.mErrorTextView.setText("");
                    ConfirmLockPasswordFragment.this.mPasswordEntry.setVisibility(0);
                    ConfirmLockPasswordFragment.this.mPasswordEntry.setAlpha(1.0f);
                ...
                public /* synthetic */ void lambda$onFinish$0$ConfirmLockPassword$ConfirmLockPasswordFragment$3() {
                    ConfirmLockPasswordFragment.this.lambda$handleAttemptLockout$1();
                }
            }.start();
            ThreadUtils.postOnMainThread(new Runnable() {
                /* class com.android.settings.password.$$Lambda$ConfirmLockPassword$ConfirmLockPasswordFragment$h2qJuSjHY5ZQFlCqtgB0es4Z9M */

                public final void run() {
                    ConfirmLockPassword.ConfirmLockPasswordFragment.this.lambda$handleAttemptLockout$1$ConfirmLockPassword$ConfirmLockPasswordFragment();
                }
            });
        }
