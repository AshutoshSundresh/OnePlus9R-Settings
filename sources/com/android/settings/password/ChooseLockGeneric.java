...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private Preference mHeaderMarginPreference;
        ...
        public void onCreate(Bundle bundle) {
            ...
            if (WizardManagerHelper.isDeviceProvisioned(activity) || canRunBeforeDeviceProvisioned()) {
                ...
                if (activity.isInMultiWindowMode()) {
                    Toast.makeText(activity, C0017R$string.feature_not_support_split_screen, 0).show();
                    activity.finish();
                    return;
                }
        ...
        public void addPreferences() {
            ...
            this.mHeaderMarginPreference = findPreference("preference_divider_line");
        ...
        private void updatePreferenceText() {
            if (this.mForFingerprint) {
                this.mHeaderMarginPreference.setVisible(false);
