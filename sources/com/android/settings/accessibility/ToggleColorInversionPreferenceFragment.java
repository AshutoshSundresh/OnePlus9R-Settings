...
public class ToggleColorInversionPreferenceFragment extends ToggleFeaturePreferenceFragment {
    ...
    public void onPreferenceToggled(String str, boolean z) {
        if (z) {
            Toast.makeText(getPrefContext(), C0017R$string.oneplus_screen_features_not_available_toast, 0).show();
        }
    ...
    public void onSettingsClicked(ShortcutPreference shortcutPreference) {
        ...
        Intent intent = new Intent(getContext(), ToggleScreenDetailActivity.class);
        intent.putExtra("title", getPrefContext().getString(C0017R$string.accessibility_shortcut_title, this.mPackageName));
        intent.putExtra("type", 0);
        intent.putExtra("checked", this.mShortcutPreference.isChecked());
        intent.putExtra("component", this.mComponentName);
