...
public class AccessibilityEditDialogUtils {
    ...
    static View createEditDialogContentView(Context context, int i) {
    ...
    private static void setupShortcutWidget(View view, CharSequence charSequence, CharSequence charSequence2, int i) {
        ((TextView) view.findViewById(C0010R$id.checkbox_text)).setText(charSequence);
    ...
    private static void initSoftwareShortcut(Context context, View view) {
        ...
        setupShortcutWidget(findViewById, retrieveTitle(context), retrieveSummary(context, ((TextView) findViewById.findViewById(C0010R$id.summary)).getLineHeight()), C0008R$drawable.op_accessibility_shortcut_type_software);
    }

    private static void initHardwareShortcut(Context context, View view) {
        setupShortcutWidget(view.findViewById(C0010R$id.hardware_shortcut), context.getText(C0017R$string.accessibility_shortcut_edit_dialog_title_hardware), context.getText(C0017R$string.accessibility_shortcut_edit_dialog_summary_hardware), C0008R$drawable.op_accessibility_shortcut_type_hardware);
    }

    private static void initMagnifyShortcut(Context context, View view) {
        setupShortcutWidget(view.findViewById(C0010R$id.triple_tap_shortcut), context.getText(C0017R$string.accessibility_shortcut_edit_dialog_title_triple_tap), context.getText(C0017R$string.accessibility_shortcut_edit_dialog_summary_triple_tap), C0008R$drawable.op_accessibility_shortcut_type_triple_tap);
    }
