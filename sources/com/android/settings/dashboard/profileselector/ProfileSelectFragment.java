...
public abstract class ProfileSelectFragment extends DashboardFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (Utils.getManagedProfile(UserManager.get(getContext())) != null) {
            configViewPagerMarginTop(viewPager);
        }
        ...
        FrameLayout frameLayout = (FrameLayout) this.mContentView.findViewById(16908351);
    ...
    private void configViewPagerMarginTop(View view) {
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        if (layoutParams instanceof LinearLayout.LayoutParams) {
            ((LinearLayout.LayoutParams) layoutParams).topMargin = getContext().getResources().getDimensionPixelSize(C0007R$dimen.oneplus_contorl_padding_space2);
            view.requestLayout();
        }
    }
