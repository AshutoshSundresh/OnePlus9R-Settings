        ...
        if (this.mCategories == null) {
            ...
            for (DashboardCategory dashboardCategory : categories) {
                ...
                if (Build.DEBUG_ONEPLUS) {
                    Log.d("CategoryManager", "tryInitCategories category.key:" + dashboardCategory.key + " category:" + dashboardCategory);
                    for (Tile tile : dashboardCategory.getTiles()) {
                        Log.d("CategoryManager", "tryInitCategories tiles getCategory:" + tile.getCategory());
                        Log.d("CategoryManager", "tryInitCategories tiles getPackageName:" + tile.getPackageName());
                        Log.d("CategoryManager", "tryInitCategories tiles getComponentName:" + tile.getComponentName());
                        Log.d("CategoryManager", "tryInitCategories===================================");
                    }
                }
            }
