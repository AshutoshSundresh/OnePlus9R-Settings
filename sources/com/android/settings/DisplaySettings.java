...
import com.oneplus.settings.utils.SeekBarVibratorHelper;
...
public class DisplaySettings extends SettingsPreferenceFragment implements ColorPickerPreference.CustomColorClickListener, Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener, OPBrightnessSeekbarPreferenceCategory.OPCallbackBrightness {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (OPUtils.isGuestMode()) {
                arrayList.add("dark_ui_mode");
            }
            if (!OPUtils.isSupportViewSR()) {
                arrayList.add("video_super_compensation");
            }
            if (!OPUtils.isSupportADFR()) {
                arrayList.add("oplus_o_sync_mode");
            }
            return arrayList;
        }
    };
    ...
    private SwitchPreference mOSyncModePreference;
    private Preference mReadingModePreference;
    RefreshRateObserver mRefreshRateObserver;
    ...
    private Preference mVideoSuperCompensation;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!isDozeAvailable(activity)) {
            Preference preference3 = this.mDoze801Preference;
            if (preference3 != null) {
                preference3.setVisible(false);
            }
            Preference preference4 = this.mDozePreference;
            if (preference4 != null) {
                preference4.setVisible(false);
            }
        } else if (OPUtils.isSupportCustomFingerprint()) {
            Preference preference5 = this.mDozePreference;
            if (preference5 != null) {
                preference5.setVisible(false);
            }
        } else {
            Preference preference6 = this.mDoze801Preference;
            if (preference6 != null) {
                preference6.setVisible(false);
            }
            if (OPUtils.isSupportAlwaysOnDisplay() && (preference2 = this.mDozePreference) != null) {
                preference2.setSummary(C0017R$string.oneplus_hand_up_proximity_title);
            }
        }
        boolean z = true;
        ...
        RefreshRateObserver refreshRateObserver = new RefreshRateObserver(this.mHandler);
        this.mRefreshRateObserver = refreshRateObserver;
        refreshRateObserver.startObserving();
        this.mOSyncModePreference = (SwitchPreference) findPreference("oplus_o_sync_mode");
        int i = Settings.System.getInt(getContentResolver(), "osync_feature_switch", 0);
        boolean z2 = Settings.Global.getInt(this.mContext.getContentResolver(), "oneplus_screen_refresh_rate", 0) != 1;
        this.mOSyncModePreference.setChecked(i == 1);
        this.mOSyncModePreference.setEnabled(z2);
        this.mOSyncModePreference.setOnPreferenceChangeListener(this);
        if (!OPUtils.isSupportADFR()) {
            this.mOSyncModePreference.setVisible(false);
        }
        this.mVideoEnhancerPreference = findPreference("video_enhancer");
        if (!OPUtils.isSupportVideoEnhancer() && (preference = this.mVideoEnhancerPreference) != null) {
        ...
        findPreference("graphics_enhancement_engine");
        if (!OPUtils.isSupportMotionGraphicsCompensation()) {
            this.mGraphicsDynamicOptimization.setVisible(false);
            this.mMotionGraphicsCompensation.setVisible(false);
        }
        if (OPUtils.isSupportMotionGraphicsCompensation()) {
            this.mVideoEnhancerPreference.setVisible(false);
        }
        this.mVideoSuperCompensation = findPreference("video_super_compensation");
        if (!OPUtils.isSupportViewSR()) {
            this.mVideoSuperCompensation.setVisible(false);
        }
        ...
        this.mDarkUiModePreference = findPreference("dark_ui_mode");
        if (OPUtils.isGuestMode()) {
            this.mDarkUiModePreference.setVisible(false);
        }
    }
    ...
    public static boolean isCameraGestureAvailable(Resources resources) {
        return (resources.getInteger(17694764) != -1) && !SystemProperties.getBoolean("gesture.disable_camera_launch", false);
    }
    ...
    public void onResume() {
        super.onResume();
        SeekBarVibratorHelper.getInstance().init(this.mContext);
        updateState();
    ...
    public void onDestroy() {
        ...
        RefreshRateObserver refreshRateObserver = this.mRefreshRateObserver;
        if (refreshRateObserver != null) {
            refreshRateObserver.stopObserving();
        }
    }
    ...
    private void updateState() {
        ...
        if (this.mGraphicsDynamicOptimization != null) {
            if (!OPUtils.isSupportIRISHQV()) {
                this.mGraphicsDynamicOptimization.setSummary(SystemProperties.getBoolean("persist.sys.oem.vendor.media.vpp.enable", false) ? C0017R$string.switch_on_text : C0017R$string.switch_off_text);
            } else {
        ...
        Preference preference2 = this.mVideoSuperCompensation;
        if (preference2 != null && preference2.isVisible()) {
            this.mVideoSuperCompensation.setSummary(Settings.Global.getInt(this.mContext.getContentResolver(), "oplus.software.video.sr_support", 0) == 1 ? C0017R$string.switch_on_text : C0017R$string.switch_off_text);
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        if ("video_enhancer".equals(key)) {
            ...
            OPUtils.sendAppTracker("video_enhancer", str);
        }
        if ("oplus_o_sync_mode".equals(key)) {
            boolean booleanValue3 = ((Boolean) obj).booleanValue();
            Settings.System.putInt(getContentResolver(), "osync_feature_switch", booleanValue3 ? 1 : 0);
            if (!booleanValue3) {
                str2 = "0";
            }
            OPUtils.sendAppTracker("o_sync", str2);
        }
        return true;
    }
    ...
    @Override // com.oneplus.settings.ui.OPBrightnessSeekbarPreferenceCategory.OPCallbackBrightness
    public void onOPBrightValueChanged(SeekBar seekBar, int i, int i2) {
        ValueAnimator valueAnimator = this.mSliderAnimator;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ...
        if (j <= 0) {
            ...
            SeekBarVibratorHelper.getInstance().doSeekBarVibrate(seekBar, i2);
            setBrightness(i2);
        } else if (DEBUG) {
    ...
    private void updateSlider() {
        ...
        if (Settings.System.getInt(getContentResolver(), "screen_brightness_mode", 0) != 0) {
            ...
            long abs = (long) ((Math.abs(this.mBrightPreference.getBrightness() - i) * 3000) / BrightnessUtils.GAMMA_SPACE_MAX);
    ...
    private class BrightnessObserver extends ContentObserver {
        ...
        private long getDuration() {
            long intForUser = (long) Settings.System.getIntForUser(DisplaySettings.this.mContext.getContentResolver(), "screen_brightness_animation_duration", 0, -2);
            Log.i("DisplaySettings", "animationDuration:" + intForUser);
            return intForUser;
        }
        ...
        public void onChange(boolean z, Uri uri) {
            if (!z) {
                try {
                    ...
                    DisplaySettings.this.mAnimationDuration = getDuration();
    ...
    private class RefreshRateObserver extends ContentObserver {
        private final Uri mScreenRefreshRate = Settings.Global.getUriFor("oneplus_screen_refresh_rate");
        ...
        public void onChange(boolean z, Uri uri) {
            if (this.mScreenRefreshRate.equals(uri)) {
                boolean z2 = false;
                if (Settings.Global.getInt(DisplaySettings.this.mContext.getContentResolver(), "oneplus_screen_refresh_rate", 0) != 1) {
                    z2 = true;
                }
                DisplaySettings.this.mOSyncModePreference.setEnabled(z2);
            }
        }
        ...
        public void startObserving() {
            ContentResolver contentResolver = DisplaySettings.this.mContext.getContentResolver();
            contentResolver.unregisterContentObserver(this);
            contentResolver.registerContentObserver(this.mScreenRefreshRate, false, this, -1);
        }
