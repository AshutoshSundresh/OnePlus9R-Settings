...
public class MasterClearConfirm extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mContentView = layoutInflater.inflate(C0012R$layout.master_clear_confirm, (ViewGroup) null);
        FrameLayout frameLayout = (FrameLayout) getActivity().findViewById(C0010R$id.content_parent);
        if (frameLayout != null) {
