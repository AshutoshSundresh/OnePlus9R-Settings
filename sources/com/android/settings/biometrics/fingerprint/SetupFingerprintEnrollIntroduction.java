...
public class SetupFingerprintEnrollIntroduction extends FingerprintEnrollIntroduction {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (textView != null) {
            if (OPUtils.isO2()) {
                textView.setTextColor(getResources().getColor(C0006R$color.op_setupwizard_oxygen_accent_color));
            }
            textView.setOnClickListener(new View.OnClickListener() {
                /* class com.android.settings.biometrics.fingerprint.$$Lambda$SetupFingerprintEnrollIntroduction$xs4t6BYGNOKxMXZZE2E8lyO6og */

                public final void onClick(View view) {
                    SetupFingerprintEnrollIntroduction.this.lambda$onCreate$0$SetupFingerprintEnrollIntroduction(view);
                }
            });
        }
    }
    ...
    public /* synthetic */ void lambda$onCreate$0$SetupFingerprintEnrollIntroduction(View view) {
