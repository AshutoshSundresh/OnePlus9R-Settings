...
public class DevelopmentSettingsDashboardFragment extends RestrictedDashboardFragment implements SwitchBar.OnSwitchChangeListener, OemUnlockDialogHost, AdbDialogHost, AdbClearKeysDialogHost, LogPersistDialogHost, BluetoothA2dpHwOffloadRebootDialog.OnA2dpHwDialogConfirmedListener, AbstractBluetoothPreferenceController.Callback {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (defaultAdapter != null && defaultAdapter.isEnabled()) {
            Log.d("DevSettingsDashboard", "bluetooth on");
        ...
        if (!isFiveGEnabled(getActivity()) || !ProductUtils.isdual5GProject()) {
            ((PreferenceCategory) findPreference("debug_networking_category")).removePreference(findPreference("vonr_option"));
        }
    ...
    public void onDestroyView() {
        ...
        if (defaultAdapter != null) {
            defaultAdapter.closeProfileProxy(2, this.mBluetoothA2dp);
            BluetoothA2dp bluetoothA2dp = this.mLastConnectedBluetoothA2dp;
            if (!(bluetoothA2dp == null || bluetoothA2dp == this.mBluetoothA2dp)) {
    ...
    private static boolean isFiveGEnabled(android.content.Context r6) {
        /*
            java.lang.String r0 = "preferred_network_mode"
            ...
            int r2 = android.telephony.SubscriptionManager.getPhoneId(r1)
            java.lang.String r3 = "ro.telephony.default_network"
            r4 = -1
            int r3 = android.os.SystemProperties.getInt(r3, r4)
            android.content.ContentResolver r4 = r6.getContentResolver()     // Catch:{ SettingNotFoundException -> 0x0031 }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ SettingNotFoundException -> 0x0031 }
            r5.<init>()     // Catch:{ SettingNotFoundException -> 0x0031 }
            r5.append(r0)     // Catch:{ SettingNotFoundException -> 0x0031 }
            r5.append(r1)     // Catch:{ SettingNotFoundException -> 0x0031 }
            java.lang.String r1 = r5.toString()     // Catch:{ SettingNotFoundException -> 0x0031 }
            int r3 = android.provider.Settings.Global.getInt(r4, r1)     // Catch:{ SettingNotFoundException -> 0x0031 }
            goto L_0x0039
        L_0x0031:
            android.content.ContentResolver r6 = r6.getContentResolver()     // Catch:{ SettingNotFoundException -> 0x0039 }
            int r3 = android.telephony.TelephonyManager.getIntAtIndex(r6, r0, r2)     // Catch:{ SettingNotFoundException -> 0x0039 }
        L_0x0039:
            java.lang.StringBuilder r6 = new java.lang.StringBuilder
            r6.<init>()
            java.lang.String r0 = "phoneNwMode ="
            r6.append(r0)
            r6.append(r3)
            java.lang.String r6 = r6.toString()
            java.lang.String r0 = "isFiveGEnabled"
        ...
        L_0x0056:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.settings.development.DevelopmentSettingsDashboardFragment.isFiveGEnabled(android.content.Context):boolean");
    }
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, Activity activity, Lifecycle lifecycle, DevelopmentSettingsDashboardFragment developmentSettingsDashboardFragment, BluetoothA2dpConfigStore bluetoothA2dpConfigStore) {
        ...
        arrayList.add(new VoNRPreferenceController(context));
