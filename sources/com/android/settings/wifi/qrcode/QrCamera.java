...
public class QrCamera extends Handler {
    ...
    private static int HARD_CODING_HEIGHT = 1080;
    private static int HARD_CODING_WIDTH = 1440;
    ...
    private boolean isSupportMultiScreenResolution() {
        Display.Mode[] supportedModes = ((DisplayManager) this.mContext.get().getSystemService("display")).getDisplay(0).getSupportedModes();
    ...
    public void setCameraParameter() {
        ...
        if (!isSupportMultiScreenResolution()) {
            this.mPreviewSize = new Size(HARD_CODING_WIDTH, HARD_CODING_HEIGHT);
        } else {
