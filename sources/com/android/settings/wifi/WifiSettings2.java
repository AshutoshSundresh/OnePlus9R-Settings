...
public class WifiSettings2 extends RestrictedSettingsFragment implements WifiPickerTracker.WifiPickerTrackerCallback, WifiDialog2.WifiDialog2Listener, DialogInterface.OnDismissListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0019R$xml.wifi_settings2) {
        /* class com.android.settings.wifi.WifiSettings2.AnonymousClass7 */
    ...
    public void onStart() {
        ...
        if (ProductUtils.isUsvMode()) {
            intentFilter.addAction("android.intent.action.VERIZON_INVALID_NETWORK");
        }
        SimStateChangeReceiver simStateChangeReceiver = new SimStateChangeReceiver();
        this.mSimStateChangeReceiver = simStateChangeReceiver;
        if (simStateChangeReceiver != null) {
            getPrefContext().registerReceiver(this.mSimStateChangeReceiver, intentFilter);
        }
    }
    ...
    public void onStop() {
        ...
        if (this.mSimStateChangeReceiver != null) {
            getPrefContext().unregisterReceiver(this.mSimStateChangeReceiver);
    ...
    public void lambda$new$0() {
        if (this.mWifiPickerTracker.getWifiState() == 3) {
            ...
            for (WifiEntry wifiEntry : this.mWifiPickerTracker.getWifiEntries()) {
                ...
                if (ProductUtils.isUsvMode() && isDisabledByWrongPassword(wifiEntry) && this.isDialogShown) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                    builder.setTitle(wifiEntry.getTitle());
                    builder.setMessage(C0017R$string.dialog_wrong_password);
                    builder.setPositiveButton(C0017R$string.dialog_wrong_password_ok, new DialogInterface.OnClickListener(this) {
    ...
    public void setAdditionalSettingsSummaries() {
        ...
        if (isAdded()) {
            ...
            if (this.isHaveSim != TetherUtils.isSimStatusChange(getPrefContext())) {
                this.isHaveSim = TetherUtils.isSimStatusChange(getPrefContext());
            }
            if (numSavedSubscriptions > 0 && !this.isHaveSim) {
                numSavedSubscriptions = 0;
            }
    ...
    /* access modifiers changed from: package-private */
    public void connect(final WifiEntry wifiEntry, final boolean z, final boolean z2) {
        this.mMetricsFeatureProvider.action(getActivity(), 135, wifiEntry.isSaved());
        if (!ProductUtils.isUsvMode() || wifiEntry.getSecurity() != 0) {
            wifiEntry.connect(new WifiEntryConnectCallback(wifiEntry, z, z2));
            return;
        }
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
        builder.setMessage(getContext().getString(C0017R$string.dialog_open_network_title) + " " + wifiEntry.getSsid() + " " + getContext().getString(C0017R$string.dialog_open_network_title_info));
        builder.setNegativeButton(C0017R$string.dialog_open_network_cancel, new DialogInterface.OnClickListener(this) {
            /* class com.android.settings.wifi.WifiSettings2.AnonymousClass5 */

            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
            }
        });
        builder.setPositiveButton(C0017R$string.dialog_open_network_connect, new DialogInterface.OnClickListener() {
            /* class com.android.settings.wifi.WifiSettings2.AnonymousClass6 */

            public void onClick(DialogInterface dialogInterface, int i) {
                WifiEntry wifiEntry = wifiEntry;
                wifiEntry.connect(new WifiEntryConnectCallback(wifiEntry, z, z2));
                dialogInterface.dismiss();
            }
        });
    ...
    private class SimStateChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, Intent intent) {
            ...
            } else if ("android.intent.action.VERIZON_INVALID_NETWORK".equals(intent.getAction())) {
                int i = Settings.System.getInt(context.getContentResolver(), OPAutoSwitchMobileDataPreferenceController.WIFI_AUTO_CHANGE_TO_MOBILE_DATA, 0);
                int i2 = Settings.System.getInt(context.getContentResolver(), "dialogbadwifishown", 0);
                if (ProductUtils.isUsvMode() && i == 0 && i2 == 0) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(context);
                    builder.setMessage(context.getString(C0017R$string.avoid_bad_wifi_connection_dialog_title));
                    builder.setCancelable(false);
                    builder.setNegativeButton(context.getString(C0017R$string.go_to_settings), new DialogInterface.OnClickListener(this) {
                        /* class com.android.settings.wifi.WifiSettings2.SimStateChangeReceiver.AnonymousClass2 */

                        public void onClick(DialogInterface dialogInterface, int i) {
                            dialogInterface.dismiss();
                            Intent intent = new Intent("oneplus.intent.action.OP_SLA");
                            intent.addFlags(268435456);
                            context.startActivity(intent);
                        }
                    });
                    builder.setPositiveButton(context.getString(C0017R$string.no_thanks), new DialogInterface.OnClickListener(this) {
                        /* class com.android.settings.wifi.WifiSettings2.SimStateChangeReceiver.AnonymousClass1 */
                    ...
                    AlertDialog create = builder.create();
                    Settings.System.putInt(context.getContentResolver(), "dialogbadwifishown", 1);
                    create.show();
                }
            }
        }
