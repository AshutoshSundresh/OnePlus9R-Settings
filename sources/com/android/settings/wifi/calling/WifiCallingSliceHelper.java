...
public class WifiCallingSliceHelper {
    ...
    private Slice getWifiCallingPreferenceSlice(boolean z, int i, Uri uri, int i2) {
        ...
        if (z) {
            listBuilder.addRow(wifiPreferenceRowBuilder(listBuilder, 17041479, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_WIFI_ONLY", i == 0, i2));
        }
        listBuilder.addRow(wifiPreferenceRowBuilder(listBuilder, 17041480, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_WIFI_PREFERRED", i == 2, i2));
        listBuilder.addRow(wifiPreferenceRowBuilder(listBuilder, 17041477, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_CELLULAR_PREFERRED", i == 1, i2));
        return listBuilder.build();
    }
    ...
    private CharSequence getWifiCallingPreferenceSummary(int i, int i2) {
        Resources resourcesForSubId = getResourcesForSubId(i2);
        if (i == 0) {
            return resourcesForSubId.getText(17041479);
        }
        if (i == 1) {
        ...
        return resourcesForSubId.getText(17041480);
    }
