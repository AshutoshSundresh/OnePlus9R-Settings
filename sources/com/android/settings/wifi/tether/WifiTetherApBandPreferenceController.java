...
public class WifiTetherApBandPreferenceController extends WifiTetherBasePreferenceController {
    ...
    DialogInterface.OnClickListener onWarningDialogCLickListner = new DialogInterface.OnClickListener() {
        /* class com.android.settings.wifi.tether.WifiTetherApBandPreferenceController.AnonymousClass1 */

        public void onClick(DialogInterface dialogInterface, int i) {
            if (i == -1) {
                WifiTetherApBandPreferenceController wifiTetherApBandPreferenceController = WifiTetherApBandPreferenceController.this;
                wifiTetherApBandPreferenceController.mBandIndex = wifiTetherApBandPreferenceController.mNewBandIndex;
                WifiTetherApBandPreferenceController.this.preference.setSummary(WifiTetherApBandPreferenceController.this.getConfigSummary());
                WifiTetherApBandPreferenceController wifiTetherApBandPreferenceController2 = WifiTetherApBandPreferenceController.this;
                wifiTetherApBandPreferenceController2.mListener.onTetherConfigUpdated(wifiTetherApBandPreferenceController2);
            } else if (i == -2) {
                WifiTetherApBandPreferenceController.this.preference.setSummary(WifiTetherApBandPreferenceController.this.getConfigSummary());
            }
        }
    ...
    public boolean onPreferenceChange(Preference preference2, Object obj) {
        Intent intent;
        if (!this.mWifiManager.isWifiApEnabled() || this.mWifiManager.getWifiApConfiguration() == null) {
            intent = null;
        } else {
        ...
        this.mNewBandIndex = ((Integer) obj).intValue();
