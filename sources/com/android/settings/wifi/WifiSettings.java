...
public class WifiSettings extends RestrictedSettingsFragment implements WifiTracker.WifiListener, AccessPoint.AccessPointListener, WifiDialog.WifiDialogListener, DialogInterface.OnDismissListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0019R$xml.wifi_settings) {
        /* class com.android.settings.wifi.WifiSettings.AnonymousClass10 */
    ...
    public void clearNotification() {
        ...
        sharedPreferences.edit().remove("is_notified_on").commit();
        sharedPreferences.edit().remove("is_notified_off").commit();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference instanceof LongPressAccessPointPreference) {
            ...
            if (connectingType != 1) {
                ...
                builder2.setMessage(getContext().getString(C0017R$string.dialog_open_network_title) + " " + this.mSelectedAccessPoint.getTitle() + " " + getContext().getString(C0017R$string.dialog_open_network_title_info));
                this.builder.setNegativeButton(C0017R$string.dialog_open_network_cancel, new DialogInterface.OnClickListener(this) {
                ...
                this.builder.setPositiveButton(C0017R$string.dialog_open_network_connect, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        wifiSettings.connect(wifiSettings.mSelectedAccessPoint.getConfig(), WifiSettings.this.mSelectedAccessPoint.isSaved(), 0);
                        dialogInterface.dismiss();
                    }
                });
                ...
                this.mSelectedAccessPoint.generateOpenNetworkConfig();
                connect(this.mSelectedAccessPoint.getConfig(), this.mSelectedAccessPoint.isSaved(), 0);
            }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:45:0x00ed */
    ...
    public void connect(WifiConfiguration wifiConfiguration, boolean z, int i) {
        if (!ProductUtils.isUsvMode() || !wifiConfiguration.getPrintableSsid().equalsIgnoreCase("VerizonWiFiAccess") || SubscriptionManager.from(getActivity()).getActiveSubscriptionInfoList(true).size() != 0) {
        ...
        this.mClickedConnect = false;
        Toast.makeText(getActivity(), "UICC is required to login to the WiFi network with SSID VerizonWiFiAccess", 0).show();
    }
    ...
    private void startWapiCertManage() {
        ...
        builder2.setMessage(getString(C0017R$string.wapi_no_vaild_cert));
        builder2.setCancelable(false);
        builder2.setPositiveButton(C0017R$string.wapi_yes, new DialogInterface.OnClickListener() {
            /* class com.android.settings.wifi.WifiSettings.AnonymousClass8 */
        ...
        builder2.setNegativeButton(C0017R$string.wapi_no, new DialogInterface.OnClickListener(this) {
            /* class com.android.settings.wifi.WifiSettings.AnonymousClass9 */
