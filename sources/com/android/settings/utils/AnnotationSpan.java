...
public class AnnotationSpan extends URLSpan {
    ...
    public static CharSequence textWithoutLink(CharSequence charSequence) {
        ...
        Arrays.sort(annotationArr, Comparator.comparingInt(new ToIntFunction(spannableString) {
            /* class com.android.settings.utils.$$Lambda$AnnotationSpan$vkxOAkOrk8m9VmpwaIv8NveV4 */
    ...
    static /* synthetic */ int lambda$textWithoutLink$0(SpannableString spannableString, Annotation annotation) {
