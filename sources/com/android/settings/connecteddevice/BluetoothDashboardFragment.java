...
public class BluetoothDashboardFragment extends DashboardFragment {
                    ...
                    if (BluetoothDashboardFragment.this.mPodsService != null) {
                        ...
                        if (bluetoothDevice != null && BluetoothDashboardFragment.this.mPodsService.isOnePlusPods(address)) {
                            ...
                            if (stringExtra != null && objArr != null && objArr.length == 7) {
                                int batteryLevel = BluetoothDashboardFragment.this.getBatteryLevel(objArr[2]);
                                int batteryLevel2 = BluetoothDashboardFragment.this.getBatteryLevel(objArr[4]);
                                int batteryLevel3 = BluetoothDashboardFragment.this.getBatteryLevel(objArr[6]);
                                Log.d("BluetoothDashboardFrag", "ACTION_VENDOR_SPECIFIC_HEADSET_EVENT address = " + address + ", leftLevel: " + batteryLevel + ", rightLevel: " + batteryLevel2 + ", boxLevel: " + batteryLevel3);
                                String batteryString = BluetoothDashboardFragment.this.getBatteryString(batteryLevel, batteryLevel2, batteryLevel3);
    ...
    private void bindOnePlusPodsService(CachedBluetoothDevice cachedBluetoothDevice) {
        ...
        ServiceConnection serviceConnection = this.mConnecttion;
    ...
    private int getBatteryLevel(Object obj) {
        ...
        Log.d("BluetoothDashboardFrag", "getBatteryLevel value = " + intValue + " level = " + i);
        return i;
    }
