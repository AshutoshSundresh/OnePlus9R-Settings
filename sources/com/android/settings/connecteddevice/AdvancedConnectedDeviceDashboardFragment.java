...
public class AdvancedConnectedDeviceDashboardFragment extends DashboardFragment implements NfcUiccObserver.OnNfcUiccChangeCallback {
    ...
    public static List<AbstractPreferenceController> buildControllers(Context context, Lifecycle lifecycle, Fragment fragment) {
        ...
        DefaultPaymentSettingsPreferenceController defaultPaymentSettingsPreferenceController = new DefaultPaymentSettingsPreferenceController(context, lifecycle, "default_payment_app");
        if (fragment != null) {
