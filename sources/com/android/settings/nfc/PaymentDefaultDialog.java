...
public final class PaymentDefaultDialog extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    private boolean buildDialog(ComponentName componentName, String str) {
        if (componentName == null || str == null) {
            ...
            Log.d("PaymentDefaultDialog", "defaultComponent : " + defaultPaymentApp);
            if (defaultPaymentApp == null || !defaultPaymentApp.equals(componentName) || defaultPaymentApp.toString().contains("com.finshell.wallet/com.nearme.wallet.nfc.CardService")) {
