...
public class NfcForegroundPreferenceController extends BasePreferenceController implements PaymentBackend.Callback, Preference.OnPreferenceChangeListener, LifecycleObserver, OnStart, OnStop {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        oPNfcForegroundPreference.setNegativeButtonText((CharSequence) null);
        this.mPreference.setPositiveButtonText((CharSequence) null);
        OPNfcForegroundPreference oPNfcForegroundPreference2 = this.mPreference;
        if (oPNfcForegroundPreference2 != null && (paymentBackend = this.mPaymentBackend) != null) {
            oPNfcForegroundPreference2.setPaymentBackend(paymentBackend);
        }
    }
