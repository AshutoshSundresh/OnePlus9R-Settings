...
public class EligibleCardChecker implements Callable<ContextualCard> {
        ...
        ThreadUtils.postOnMainThread(new Runnable(uri, r0) {
            ...
            public final void run() {
                AsyncTask.execute((SliceViewManager) new Runnable(this.f$1, this.f$2) {
                    ...
                    public final void run() {
                        EligibleCardChecker.lambda$bindSlice$1(SliceViewManager.this, this.f$1, this.f$2);
                    }
                });
            }
        });
    ...
    static /* synthetic */ void lambda$bindSlice$1(SliceViewManager sliceViewManager, Uri uri, SliceViewManager.SliceCallback sliceCallback) {
        try {
