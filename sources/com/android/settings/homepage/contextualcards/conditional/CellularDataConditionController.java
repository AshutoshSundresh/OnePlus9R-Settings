...
public class CellularDataConditionController implements ConditionalCardController, OnDestroy {
    ...
    private final PhoneStateListener mPhoneStateListener = new OPPhoneStateListener(this.mConditionManager);
    private int mSubId;
    ...
    private static class OPPhoneStateListener extends PhoneStateListener {
        WeakReference<ConditionManager> conditionManagerWeakReference;

        OPPhoneStateListener(ConditionManager conditionManager) {
            this.conditionManagerWeakReference = new WeakReference<>(conditionManager);
        }

        public void onPreciseDataConnectionStateChanged(PreciseDataConnectionState preciseDataConnectionState) {
            if (this.conditionManagerWeakReference.get() != null) {
                this.conditionManagerWeakReference.get().onConditionChanged();
            }
        }
    }
