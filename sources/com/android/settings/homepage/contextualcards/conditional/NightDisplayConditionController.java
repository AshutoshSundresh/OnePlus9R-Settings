...
public class NightDisplayConditionController implements ConditionalCardController, NightDisplayListener.Callback {
    ...
    public void onPrimaryClick(Context context) {
        ...
        subSettingLauncher.addFlags(805306368);
    ...
    public ContextualCard buildContextualCard() {
        ...
        builder.setName(this.mAppContext.getPackageName() + "/" + ((Object) this.mAppContext.getText(C0017R$string.oneplus_condition_night_display_title)));
        builder.setTitleText(this.mAppContext.getText(C0017R$string.oneplus_condition_night_display_title).toString());
