...
public class LocationSettings extends DashboardFragment {
    ...
    public void onAttach(Context context) {
        ...
        ((CarrierLocationAccessController) use(CarrierLocationAccessController.class)).init(this);
    }
    ...
    public void onStart() {
        super.onStart();
        if (OPUtils.isSupportUstMode() && !this.isLoadPage) {
            updateExpandedChildCount();
    ...
    private void updateExpandedChildCount() {
        PreferenceCategory preferenceCategory;
        if (getPreferenceScreen() != null && (preferenceCategory = (PreferenceCategory) getPreferenceScreen().findPreference("location_advanced_settings")) != null) {
            preferenceCategory.setInitialExpandedChildrenCount(3);
        }
    }
}
