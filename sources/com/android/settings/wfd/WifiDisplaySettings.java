...
public final class WifiDisplaySettings extends SettingsPreferenceFragment implements SwitchBar.OnSwitchChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mWifiP2pChannel = wifiP2pManager.initialize(activity.getApplicationContext(), Looper.getMainLooper(), null);
        ...
        this.mDescriptionPreference = getPreferenceScreen().findPreference("wifi_display_settings_description");
    ...
    public void onStart() {
        ...
        SwitchBar switchBar3 = this.mSwitchBar;
        if (switchBar3 != null) {
            switchBar3.setChecked(z);
    ...
    private void handleStateOn() {
        ...
        for (WifiDisplay wifiDisplay : displays) {
            if (!wifiDisplay.isRemembered() && wifiDisplay.isAvailable() && !wifiDisplay.equals(this.mWifiDisplayStatus.getActiveDisplay())) {
                Log.d("WifiDisplaySettings", "handleStateOn addPreference UnpairedWifiDisplayPreference");
    ...
    private RoutePreference createRoutePreference(MediaRouter.RouteInfo routeInfo) {
        ...
        if (findWifiDisplay != null) {
            Log.d("WifiDisplaySettings", "createRoutePreference WifiDisplayRoutePreference()");
            return new WifiDisplayRoutePreference(getPrefContext(), routeInfo, findWifiDisplay);
        }
        Log.d("WifiDisplaySettings", "createRoutePreference RoutePreference");
    ...
    private void buildCertificationMenu(PreferenceScreen preferenceScreen) {
                ...
                this.mCertCategory.addPreference(new Preference(getPrefContext()) {
                    ...
                    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            /* class com.android.settings.wfd.WifiDisplaySettings.AnonymousClass2.AnonymousClass1 */
                        ...
                        button2.setOnClickListener(new View.OnClickListener() {
                            /* class com.android.settings.wfd.WifiDisplaySettings.AnonymousClass2.AnonymousClass2 */
        ...
        AnonymousClass3 r11 = new SwitchPreference(getPrefContext()) {
        ...
        AnonymousClass4 r112 = new SwitchPreference(getPrefContext()) {
    ...
    private void setListenMode(final boolean z) {
        AnonymousClass10 r0 = new WifiP2pManager.ActionListener(this) {
    ...
    private void toggleRoute(MediaRouter.RouteInfo routeInfo) {
        Log.d("WifiDisplaySettings", "toggleRoute route= " + routeInfo);
    ...
    private void pairWifiDisplay(WifiDisplay wifiDisplay) {
        if (wifiDisplay.canConnect()) {
            Log.d("WifiDisplaySettings", "pairWifiDisplay display.getDeviceAddress() = " + wifiDisplay.getDeviceAddress());
    ...
    private void showWifiDisplayOptionsDialog(final WifiDisplay wifiDisplay) {
        ...
        AnonymousClass13 r1 = new DialogInterface.OnClickListener() {
    ...
    public class WifiDisplayRoutePreference extends RoutePreference implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (!WifiDisplaySettings.this.mLocationManager.isLocationEnabled()) {
                Toast.makeText(WifiDisplaySettings.this.getPrefContext(), C0017R$string.op_gps_off_warn_msg, 0).show();
            } else {
                WifiDisplaySettings.this.showWifiDisplayOptionsDialog(this.mDisplay);
            }
        }

        @Override // com.android.settings.wfd.WifiDisplaySettings.RoutePreference, androidx.preference.Preference.OnPreferenceClickListener
        public boolean onPreferenceClick(Preference preference) {
            if (WifiDisplaySettings.this.mLocationManager.isLocationEnabled()) {
