...
public class ApnSettings extends RestrictedSettingsFragment implements Preference.OnPreferenceChangeListener {
    ...
    private SubscriptionInfo mLastSubscriptionInfo;
            ...
            if (intent.getAction().equals("android.telephony.action.SUBSCRIPTION_CARRIER_IDENTITY_CHANGED")) {
                if (!ApnSettings.mRestoreDefaultApnMode) {
                    ...
                    if (SubscriptionManager.isValidSubscriptionId(intExtra) && ApnSettings.this.mPhoneId == SubscriptionUtil.getPhoneId(context, intExtra) && intExtra != ApnSettings.this.mSubId) {
                        Log.d("ApnSettings", "Save previous sub info");
                        ApnSettings apnSettings = ApnSettings.this;
                        apnSettings.mLastSubscriptionInfo = apnSettings.mSubscriptionInfo;
                        ApnSettings.this.mSubId = intExtra;
                        ApnSettings apnSettings2 = ApnSettings.this;
                        apnSettings2.mSubscriptionInfo = apnSettings2.getSubscriptionInfo(apnSettings2.mSubId);
                        ApnSettings apnSettings3 = ApnSettings.this;
                        apnSettings3.restartPhoneStateListener(apnSettings3.mSubId);
                    }
                    ApnSettings.this.fillList();
                }
                ...
                if (intExtra2 != -1) {
                    ...
                    if ((ApnSettings.this.mSubscriptionInfo != null && ApnSettings.this.mSubscriptionInfo.getSimSlotIndex() == intExtra2) || (ApnSettings.this.mLastSubscriptionInfo != null && ApnSettings.this.mLastSubscriptionInfo.getSimSlotIndex() == intExtra2)) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mLastSubscriptionInfo = null;
    ...
    public void onDestroy() {
        ...
        RestoreApnUiHandler restoreApnUiHandler = this.mRestoreApnUiHandler;
        if (restoreApnUiHandler != null) {
            restoreApnUiHandler.removeMessages(2);
        }
    }
    ...
    private void fillList() {
        ...
        if (query != null) {
            ...
            preferenceGroup2.addPreference(oPPreferenceHeaderMargin);
        }
    }
