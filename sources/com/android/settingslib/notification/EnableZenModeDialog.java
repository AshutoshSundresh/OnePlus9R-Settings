...
public class EnableZenModeDialog {
    ...
    public Dialog createDialog() {
        ...
        builder.setTitle(R$string.zen_mode_settings_turn_on_dialog_title);
        builder.setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) null);
        builder.setPositiveButton(R$string.zen_mode_enable_dialog_turn_on, new DialogInterface.OnClickListener() {
