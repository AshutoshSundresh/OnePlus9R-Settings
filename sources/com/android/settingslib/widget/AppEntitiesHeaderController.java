...
public class AppEntitiesHeaderController {
    ...
    private void bindAppEntityView(int i) {
        ...
        if (appEntityInfo != null) {
            ...
            this.mAppSummaryViews[i].setText(handleSummaryDot(summary));
        }
    }

    private String handleSummaryDot(CharSequence charSequence) {
        ...
        return charSequence2.contains("min.") ? charSequence2.replaceAll("min.", "mins") : charSequence2;
    }
