...
public class WifiEntryPreference extends Preference implements WifiEntry.WifiEntryCallback, View.OnClickListener {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (imageView2 != null && getContext() != null && this.mWifiEntry != null) {
            ...
            boolean z = Settings.System.getInt(getContext().getContentResolver(), OPPasspointPreferenceController.KEY_ONEPLUS_PASSPOINT, 0) == 1;
            ...
            if (!this.mWifiEntry.isSubscription()) {
                imageView2.setVisibility(8);
            } else if (this.mWifiEntry.isHomeProvider()) {
                Log.d("WifiEntryPreference", "onBindViewHolder isHome is true, set H icon");
                imageView2.setImageDrawable(getDrawable(R$drawable.ic_passpoint_h));
            } else {
                Log.d("WifiEntryPreference", "onBindViewHolder isRoaming is true, set R icon");
