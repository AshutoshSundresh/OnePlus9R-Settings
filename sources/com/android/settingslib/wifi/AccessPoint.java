...
public class AccessPoint implements Comparable<AccessPoint> {
                ...
                if (wifiConfiguration2 != null && wifiConfiguration2.getNetworkSelectionStatus().getNetworkSelectionStatus() != 0) {
                    ...
                    if (networkSelectionDisableReason == 1) {
                        ...
                        switch (networkSelectionDisableReason) {
                            case 10:
                                sb.append(this.mContext.getString(R$string.error_text_out_of_coverage));
                                break;
                            case 11:
                                sb.append(this.mContext.getString(R$string.error_text_not_subscribed));
                                break;
                            case 12:
                                sb.append(this.mContext.getString(R$string.error_text_problem_account_one));
                                break;
                            case 13:
                                sb.append(this.mContext.getString(R$string.error_text_already_connected));
                                break;
                            case 14:
                                sb.append(this.mContext.getString(R$string.error_text_problem_connecting));
                                break;
                            case 15:
                                sb.append(this.mContext.getString(R$string.error_text_problem_account_two));
                                break;
                            case 16:
                                sb.append(this.mContext.getString(R$string.error_text_not_available));
                                break;
                        }
                    } else {
    ...
    public static String getSummary(Context context, String str, NetworkInfo.DetailedState detailedState, boolean z, String str2) {
        ...
        if (detailedState == NetworkInfo.DetailedState.CONNECTED && (networkCapabilities = connectivityManager.getNetworkCapabilities(((WifiManager) context.getSystemService(WifiManager.class)).getCurrentNetwork())) != null) {
            ...
            if (!networkCapabilities.hasCapability(16)) {
                ...
                SharedPreferences sharedPreferences = context.getSharedPreferences(OPAutoSwitchMobileDataPreferenceController.PREFS_WIFISETTINGS, 0);
                sharedPreferences.edit();
                boolean z2 = sharedPreferences.getBoolean(OPAutoSwitchMobileDataPreferenceController.AVOID_BAD_WIFI_CONNECTION_CICKED, false);
                boolean z3 = sharedPreferences.getBoolean("is_notified_off", false);
                boolean z4 = sharedPreferences.getBoolean("is_notified_on", false);
                if (z2) {
                    if (!z4) {
                        createBadWifiConnectionNotificationOn(context);
                    }
                } else if (!z3) {
                    createBadWifiConnectionNotificationOff(context);
                }
    ...
    public static void createBadWifiConnectionNotificationOff(Context context) {
        NotificationChannel notificationChannel = new NotificationChannel("bad_wifi_connection_notification_channel", "bad_wifi_connection_notification", 2);
        Notification.Builder autoCancel = new Notification.Builder(context, "bad_wifi_connection_notification_channel").setSmallIcon(R$drawable.stat_sys_wifi_signal_4).setContentTitle(context.getString(R$string.bad_wifi_connection_off_notification_title)).setContentText(context.getString(R$string.bad_wifi_connection_off_notification_sub_line)).setAutoCancel(true);
        ...
        SharedPreferences.Editor edit = context.getSharedPreferences(OPAutoSwitchMobileDataPreferenceController.PREFS_WIFISETTINGS, 0).edit();
        edit.putBoolean("is_notified_off", true);
        edit.commit();
    }

    public static void createBadWifiConnectionNotificationOn(Context context) {
        NotificationChannel notificationChannel = new NotificationChannel("bad_wifi_connection_notification_channel", "bad_wifi_connection_notification", 2);
        Notification.Builder autoCancel = new Notification.Builder(context, "bad_wifi_connection_notification_channel").setSmallIcon(R$drawable.stat_sys_wifi_signal_4).setContentTitle(context.getString(R$string.bad_wifi_connection_on_notification_title)).setContentText(context.getString(R$string.bad_wifi_connection_on_notification_sub_line)).setAutoCancel(true);
        ...
        SharedPreferences.Editor edit = context.getSharedPreferences(OPAutoSwitchMobileDataPreferenceController.PREFS_WIFISETTINGS, 0).edit();
        edit.putBoolean("is_notified_on", true);
        edit.commit();
    }
}
