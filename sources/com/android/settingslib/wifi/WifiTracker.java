    ...
    WifiTracker(Context context, WifiListener wifiListener, WifiManager wifiManager, ConnectivityManager connectivityManager, NetworkScoreManager networkScoreManager, IntentFilter intentFilter) {
        ...
        this.mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(final Context context, Intent intent) {
                ...
                if ("android.net.wifi.WIFI_STATE_CHANGED".equals(action)) {
                ...
                } else if ("android.intent.action.VERIZON_INVALID_NETWORK".equals(action) && ProductUtils.isUsvMode()) {
                    ...
                    boolean z = sharedPreferences.getBoolean(OPAutoSwitchMobileDataPreferenceController.AVOID_BAD_WIFI_CONNECTION_CICKED, false);
                    String string = sharedPreferences.getString("avoid_bad_wifi_connection_dialog_button_clicked", "no");
                    boolean z2 = sharedPreferences.getBoolean("is_showing", false);
                    AlertDialog create = new AlertDialog.Builder(context).setMessage(context.getString(R$string.avoid_bad_wifi_connection_dialog_title)).setCancelable(false).setNegativeButton(context.getString(R$string.go_to_settings), new DialogInterface.OnClickListener(this) {
                        /* class com.android.settingslib.wifi.WifiTracker.AnonymousClass2.AnonymousClass2 */

                        public void onClick(DialogInterface dialogInterface, int i) {
                            edit.putString("avoid_bad_wifi_connection_dialog_button_clicked", "yes");
                            edit.commit();
                    ...
                    }).setPositiveButton(context.getString(R$string.no_thanks), new DialogInterface.OnClickListener(this) {
                        /* class com.android.settingslib.wifi.WifiTracker.AnonymousClass2.AnonymousClass1 */
                    ...
                    if (!z && !string.equals("yes") && !z2) {
                        edit.putBoolean("is_showing", true);
                        edit.commit();
                        create.show();
                    }
                }
