...
public class PasspointWifiEntry extends WifiEntry implements WifiEntry.WifiEntryCallback {
    ...
    @Override // com.android.wifitrackerlib.WifiEntry
    public boolean isHomeProvider() {
        WifiInfo wifiInfo = this.mWifiInfo;
        if (wifiInfo == null) {
            return false;
        }
        boolean isHomeProvider = wifiInfo.isHomeProvider();
        Log.d("PasspointWifiEntry", "isHomeProvider: " + isHomeProvider + " isPasspointAp:" + this.mWifiInfo.isPasspointAp() + " FQDN:" + this.mWifiInfo.getPasspointFqdn());
        return isHomeProvider;
    }
}
