...
public class SwitchFloatingActionButton extends RelativeLayout {
    ...
    public SwitchFloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mCardViewOutlineProvider = new ViewOutlineProvider(this) {
            /* class com.google.android.material.floatingactionbutton.SwitchFloatingActionButton.AnonymousClass1 */
