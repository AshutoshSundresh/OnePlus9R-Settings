...
public class ListItemView extends LinearLayout {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mCustomViewLayout.getVisibility() == 0) {
            ...
            if (z2) {
                ...
                linearLayout.setPadding(linearLayout.getPaddingLeft(), this.mRootLayout.getPaddingTop(), this.mRootLayout.getPaddingRight(), this.mRootLayout.getPaddingBottom());
            } else {
    ...
    public void setEnabled(boolean z) {
        ...
        TextView textView2 = this.mListSummaryView;
        if (textView2 != null) {
            textView2.setEnabled(z);
        }
        LinearLayout linearLayout = this.mCustomViewLayout;
        if (linearLayout != null && linearLayout.getChildAt(0) != null) {
            this.mCustomViewLayout.getChildAt(0).setEnabled(z);
        }
    }
