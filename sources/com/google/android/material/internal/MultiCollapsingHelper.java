...
public final class MultiCollapsingHelper {
    ...
    private boolean updateTitlePosition() {
        ...
        if (this.mTitleView != null) {
            if (this.mExpandedFraction < 0.2f && !"net.oneplus.weather".equals(this.mView.getContext().getPackageName())) {
                TextView textView = this.mTitleView;
                Rect rect = this.mCollapsedBounds;
                textView.setMaxWidth(((rect.right - (rect.left * 2)) - this.mImageViewSize) + this.mMenuMargin);
            } else if (this.mExpandedFraction >= 0.5f || "net.oneplus.weather".equals(this.mView.getContext().getPackageName())) {
                TextView textView2 = this.mTitleView;
                Rect rect2 = this.mCollapsedBounds;
                textView2.setMaxWidth((rect2.right - rect2.left) - this.mImageViewSize);
            } else {
                TextView textView3 = this.mTitleView;
                Rect rect3 = this.mCollapsedBounds;
                textView3.setMaxWidth((rect3.right - rect3.left) - this.mImageViewSize);
            }
            ...
            textView4.setTextSize(0, f6 - ((f6 - this.mCollapsedTextSize) * this.mExpandedFraction));
            ...
            if (this.mSyncCollapsNull) {
                ...
                textView5.setTranslationY(f7 + (f5 * f4));
            }
        }
        TextView textView6 = this.mSubTitleView;
        if (!(textView6 == null || this.mTitleView == null)) {
            ...
            if (this.mSyncTextView != null) {
                ...
                textPaint.getTextBounds(charSequence, 0, charSequence.length(), rect4);
                float measureText2 = this.syncTextPaint.measureText(String.valueOf(this.mSyncText));
                float measureText3 = (ViewCompat.getLayoutDirection(this.mView) == 1 ? (float) (-this.mExpandedBounds.left) : this.mCollapsedDrawX) + ((float) (this.mInsetSubtitleImage ? this.mImageViewSize + 16 : 0)) + this.subtitlePaint.measureText(String.valueOf(this.subtitle)) + 24.0f;
                if (z) {
                    f2 = Math.max((((((float) this.mExpandedBounds.right) - this.subtitlePaint.measureText(String.valueOf(this.subtitle))) - measureText2) - 48.0f) - ((float) (this.mInsetSubtitleImage ? this.mImageViewSize + 16 : 0)), 0.0f);
                } else {
                    f2 = measureText3;
                }
                this.mSyncLeftX = f2;
                ...
                this.mSyncTopY = abs;
                this.mSyncBottomY = abs + ((float) rect4.height());
                if (measureText3 + measureText2 < ((float) this.mView.getResources().getDisplayMetrics().widthPixels)) {
                    ...
                    TextView textView8 = this.mSyncTextView;
                    if (z) {
                    ...
                    float height = this.mSyncBottomY + ((float) rect4.height());
                    this.mSyncTopY = height;
                    this.mSyncBottomY = height + ((float) rect4.height());
                    if (TextUtils.isEmpty(this.mSyncTextView.getText())) {
                        this.mSyncTextView.setText(this.mSyncText);
                    }
            ...
            if (this.mTextToDraw == null || z) {
                ...
                if (this.mSubTitleView != null) {
                    ...
                    if (this.mInsetSubtitleImage) {
                        ...
                        this.mImageView.setTranslationY(((float) ("net.oneplus.weather".equals(this.mView.getContext().getPackageName()) ? 4 : Math.max(round - this.mImageViewSize, 0))) + measuredHeight);
    ...
    public void setSubtitle(CharSequence charSequence) {
        ...
        if (charSequence == null || !charSequence.equals(this.subtitle)) {
            ...
            if (!TextUtils.isEmpty(charSequence) && (textView2 = this.mSubTitleView) != null) {
                ...
                this.mSubTitleView.setTranslationX(f);
