...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public final void showView() {
        if (this.view.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                ...
                ((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin = this.mBottomMargin;
    ...
    public void animateViewIn() {
        ...
        valueAnimator.setInterpolator(AnimatorUtils.op_control_interpolator_fast_out_slow_in_standard);
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    ...
                    int i = height;
                    snackbarBaseLayout.setAlpha(((float) (i - intValue)) / (((float) i) * 1.0f));
                }
