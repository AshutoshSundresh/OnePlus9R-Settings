...
public class TimePicker extends FrameLayout {
    ...
    public void setWindow(Window window) {
        ...
        if (timePickerDelegate != null && (timePickerDelegate instanceof TimePickerClockDelegate)) {
            ((TimePickerClockDelegate) timePickerDelegate).setWindow(window);
        }
    }
    ...
    public void setHasTitle(boolean z) {
        TimePickerDelegate timePickerDelegate = this.mDelegate;
        if (timePickerDelegate != null && (timePickerDelegate instanceof TimePickerClockDelegate)) {
            ((TimePickerClockDelegate) timePickerDelegate).setHasTitle(z);
        }
    }

    public boolean isPickerModeClockEnabled() {
        TimePickerDelegate timePickerDelegate = this.mDelegate;
        if (timePickerDelegate == null || !(timePickerDelegate instanceof TimePickerClockDelegate)) {
            return false;
        }
        return ((TimePickerClockDelegate) timePickerDelegate).isRadialPickerModeEnabled();
    }

    public void setSoftInputFocus() {
        TimePickerDelegate timePickerDelegate = this.mDelegate;
        if (timePickerDelegate != null && (timePickerDelegate instanceof TimePickerClockDelegate)) {
            ((TimePickerClockDelegate) timePickerDelegate).setInputPickerFocus();
        }
    }
