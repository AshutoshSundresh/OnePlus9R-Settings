...
public class SimpleMonthView extends View implements View.OnFocusChangeListener {
    ...
    private ColorStateList applyTextAppearance(Paint paint2, int i) {
        ...
        paint2.setTextSize((float) obtainStyledAttributes.getDimensionPixelSize(R$styleable.TextAppearance_android_textSize, (int) paint2.getTextSize()));
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(R$styleable.TextAppearance_android_textColor);
        if (colorStateList != null) {
            paint2.setColor(colorStateList.getColorForState(View.ENABLED_STATE_SET, 0));
        }
    ...
    public void setMonthTextAlpha(int i) {
        ...
        if (Integer.toHexString(i2).length() > 2) {
            ...
            this.mMonthPaint.setColor(new ColorStateList(new int[][]{new int[]{16842910}, new int[0]}, new int[]{bigInteger.intValue(), i2}).getColorForState(View.ENABLED_STATE_SET, 0));
            invalidate();
        }
    }
