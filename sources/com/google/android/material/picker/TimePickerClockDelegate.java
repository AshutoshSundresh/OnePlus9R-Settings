...
public class TimePickerClockDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    private final View.OnClickListener mClickListener = new View.OnClickListener() {
        /* class com.google.android.material.picker.TimePickerClockDelegate.AnonymousClass13 */
    ...
    private final Runnable mCommitMinute = new Runnable() {
        /* class com.google.android.material.picker.TimePickerClockDelegate.AnonymousClass11 */
    ...
    private final View.OnFocusChangeListener mFocusListener = new View.OnFocusChangeListener() {
        /* class com.google.android.material.picker.TimePickerClockDelegate.AnonymousClass12 */
    ...
    public void setInputPickerFocus() {
        if (this.mTextInputPickerView.getHourView().isActivated()) {
            this.mTextInputPickerView.getHourView().requestFocus();
        } else if (this.mTextInputPickerView.getMinuteView().isActivated()) {
            this.mTextInputPickerView.getMinuteView().requestFocus();
        }
    }

    public boolean isRadialPickerModeEnabled() {
        return !this.mRadialPickerModeEnabled;
    }
    ...
    private void animationInInputTimeField() {
        ...
        this.mRadialTimePickerView.animate().scaleX(this.mRadialTimeViewScale).scaleY(this.mRadialTimeViewScale).alpha(this.mRadialTimeViewAlpha).setDuration((long) this.mDuration).setInterpolator(AnimatorUtils.FastOutSlowInInterpolator).start();
        this.mRadialTimePickerHeader.setTranslationY(0.0f);
        this.mRadialTimePickerHeader.animate().setInterpolator(new LinearInterpolator()).translationY(0.0f).setDuration((long) this.mDuration).setUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                if (TimePickerClockDelegate.this.mWindow != null) {
                    ...
                    if (i3 < i2) {
                        float f = (float) i3;
                        TimePickerClockDelegate timePickerClockDelegate = TimePickerClockDelegate.this;
                        InsetDrawable insetDrawable = new InsetDrawable(TimePickerClockDelegate.this.mContext.getResources().getDrawable(R$drawable.op_picker_dialog_material_background_bottom), 0, (int) ((f - ViewUtils.dpToPx(timePickerClockDelegate.mContext, timePickerClockDelegate.mHasTitle ? 374 : 354)) * valueAnimator.getAnimatedFraction()), 0, 0);
    ...
    private void animationOutInputTimeField() {
        ...
        this.mTextInputPickerView.showLabels(false);
        this.mRadialTimePickerView.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setInterpolator(AnimatorUtils.FastOutSlowInInterpolator).setDuration((long) this.mDuration).start();
        this.mRadialTimePickerHeader.animate().translationY(0.0f).setInterpolator(AnimatorUtils.op_control_interpolator_linear_out_slow_in).setDuration((long) this.mDuration).setUpdateListener(null).setListener(new Animator.AnimatorListener() {
    ...
    private void updateHeaderAmPm() {
        ...
        updateTimeHeaderPosition(startsWith);
    ...
    private void updateTimeHeaderPosition(boolean z) {
        if (!z) {
            String charSequence = this.mAmLabel.getText().toString();
