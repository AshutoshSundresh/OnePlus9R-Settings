...
public class CollapsingAppbarLayout extends FrameLayout {
        ...
        if (parent instanceof AppBarLayout) {
            ...
            if (this.mSyncTextView == null) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    /* class com.google.android.material.appbar.CollapsingAppbarLayout.AnonymousClass2 */
    ...
    public void setSyncSubtitleAlpha(int i) {
        ...
        TextView textView2 = this.mSyncTextView;
        if (textView2 != null) {
    ...
    private void setSyncCollapsSubTitleNull(boolean z) {
        this.collapsingTextHelper.setSyncCollapsSubtitleNull(z);
    }
