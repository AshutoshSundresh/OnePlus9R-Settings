...
public class DataUsageMainActivity extends BaseTabActivity implements SimStateListener, OperatorPackageUsageUpdater {
    ...
    private final Runnable mCheckFragmentAddRunnable = new Runnable() {
        /* class com.oneplus.security.network.view.DataUsageMainActivity.AnonymousClass1 */

        public void run() {
            DataUsageMainActivity.this.checkFragmentAdd();
        }
    };
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, 100, 0, getString(C0017R$string.units_title)).setShowAsActionFlags(0);
        return true;
    }
    ...
    private void showUnitsDialog() {
        int i;
        try {
            i = Settings.System.getInt(getContentResolver(), "index_data_usage_unit");
        } catch (Exception e) {
            e.printStackTrace();
            i = 0;
        }
        String[] strArr = {getString(C0017R$string.units_one), getString(C0017R$string.units_two), getString(C0017R$string.units_three)};
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(getString(C0017R$string.units_title));
        builder.setSingleChoiceItems(strArr, i, new DialogInterface.OnClickListener() {
            /* class com.oneplus.security.network.view.$$Lambda$DataUsageMainActivity$2RBQTQoF466yvilYMj7wuVJf6m8 */

            public final void onClick(DialogInterface dialogInterface, int i) {
                DataUsageMainActivity.this.lambda$showUnitsDialog$0$DataUsageMainActivity(dialogInterface, i);
            }
        });
        builder.create().show();
    }
    ...
    /* renamed from: lambda$showUnitsDialog$0 */
    public /* synthetic */ void lambda$showUnitsDialog$0$DataUsageMainActivity(DialogInterface dialogInterface, int i) {
        if (dialogInterface != null) {
            Settings.System.putInt(getContentResolver(), "index_data_usage_unit", i);
    ...
    public void initData() {
        ...
        if (FunctionUtils.isUsvMode()) {
            Settings.System.putInt(getContentResolver(), "index_data_usage_unit", 1);
        }
    }
    ...
    @Override // androidx.fragment.app.FragmentActivity, com.oneplus.security.network.view.BaseTabActivity
    public void onResume() {
        super.onResume();
        registerListener();
        refreshDataUsageUI(null);
        getMainThreadHandler().postDelayed(this.mCheckFragmentAddRunnable, 500);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void checkFragmentAdd() {
        Fragment currentFragment = getCurrentFragment();
        LogUtils.i("DataUsageMainActivity", "onResume getCurrentFragment:" + currentFragment + "  cu.isAdded()" + currentFragment.isAdded());
    ...
    public void onPause() {
        ...
        getMainThreadHandler().removeCallbacks(this.mCheckFragmentAddRunnable);
    }
    ...
    public void onDestroy() {
        ...
        LogUtils.d("DataUsageMainActivity", "onDestroy");
        super.onDestroy();
    }
    ...
    public List<Fragment> getFragmentList() {
        ...
        LogUtils.d("DataUsageMainActivity", "getFragmentList " + fragments.isEmpty());
        if (fragments.isEmpty()) {
            fragments = Lists.newArrayList();
            if (this.mOperatorDataModelSimOne != null) {
                LogUtils.d("DataUsageMainActivity", "getFragmentList mOperatorDataModelSimOne != null");
            ...
            if (this.mOperatorDataModelSimTwo != null) {
                LogUtils.d("DataUsageMainActivity", "getFragmentList mOperatorDataModelSimTwo != null");
