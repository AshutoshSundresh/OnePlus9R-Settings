...
public class TrafficUsageAlarmUtils extends BaseSharePreference {
    ...
    public static void clearSystemDataLimitValue(Context context, int i) {
        clearTrafficUsagePreferenceStringValue(context, "system_datausage_limit_value_sim_" + OPSNSUtils.findSubIdBySlotId(i));
    }

    public static void clearSystemDataWarnValue(Context context, int i) {
        clearTrafficUsagePreferenceStringValue(context, "system_datausage_warn_value_sim_" + OPSNSUtils.findSubIdBySlotId(i));
    }
    ...
    private static void clearTrafficUsagePreferenceStringValue(Context context, String str) {
        if (str == null) {
            logOutUsingInvalidKey();
            return;
        }
