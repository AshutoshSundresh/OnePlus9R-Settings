...
import com.oneplus.security.receiver.BootDataTimeReceiver;
...
public final class SecureService extends Service {
    ...
    private BootDataTimeReceiver mBootDataTimeReceiver;
    ...
    public void onCreate() {
        ...
        this.mBootDataTimeReceiver = new BootDataTimeReceiver();
        getApplicationContext().registerReceiver(this.mBootDataTimeReceiver, intentFilter2);
    ...
    public void onDestroy() {
        ...
        getApplicationContext().unregisterReceiver(this.mBootDataTimeReceiver);
