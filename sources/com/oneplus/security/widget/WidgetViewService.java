...
public class WidgetViewService extends Service implements OperatorPackageUsageUpdater, SimStateListener, FileSystemObserver.StorageListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public synchronized void notifyMonthlyRemainingDataChanged(long j, long j2) {
        String[] strArr;
        String[] strArr2;
        ...
        if (this.mDataUsage == null || this.mDataUsage.getValue() == null || !this.mDataUsage.getValue().equals(widgetData.getValue()) || this.mDataUsage.getUnits() == null || !this.mDataUsage.getUnits().equals(widgetData.getUnits()) || this.mDataUsage.getTitle() == null || !this.mDataUsage.getTitle().equals(widgetData.getTitle())) {
            this.mDataUsage = widgetData;
