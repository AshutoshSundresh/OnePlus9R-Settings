...
public class Utils {
    ...
    public static String[] getFormattedFileSizeInMb(Context context, long j, boolean z) {
        return new String[]{String.format("%.2f", Float.valueOf((((float) Math.abs(j)) / 1024.0f) / 1024.0f)), context.getResources().getString(C0017R$string.megabyteShort)};
    }

    public static String[] getFormattedFileSizeInGb(Context context, long j, boolean z) {
        return new String[]{String.format("%.2f", Float.valueOf(((((float) Math.abs(j)) / 1024.0f) / 1024.0f) / 1024.0f)), context.getResources().getString(C0017R$string.gigabyteShort)};
    }
