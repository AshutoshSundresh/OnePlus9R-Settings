...
public class OPScreenResolutionAdjust extends SettingsPreferenceFragment implements RadioButtonPreference.OnClickListener, Preference.OnPreferenceChangeListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        /* class com.oneplus.settings.OPScreenResolutionAdjust.AnonymousClass5 */
    ...
    private int[] mDpiValues1080P = {380, 420, 480, 500, 540};
    ...
    public void onRadioButtonClicked(RadioButtonPreference radioButtonPreference) {
        if (radioButtonPreference == this.mOtherResolutionMode || radioButtonPreference == this.mOtherResolutionMode19811) {
            if (!isOtherMode() && !isIntelligentSwitchMode()) {
                showWarnigDialog(0, C0017R$string.oneplus_switch_resolution_kill_process_tips);
            }
        } else if ((radioButtonPreference == this.m1080PMode || radioButtonPreference == this.m1080PMode19811) && !is1080pMode()) {
            showWarnigDialog(1, C0017R$string.oneplus_switch_resolution_kill_process_tips);
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        showWarnigDialog(((Boolean) obj).booleanValue() ? 2 : 0, C0017R$string.oneplus_switch_intelligent_resolution_kill_process_tips);
        return true;
    }
    ...
    private void changeScreenResolution(int i) {
        int i2 = Settings.Global.getInt(this.mContext.getContentResolver(), "oneplus_screen_resolution_adjust", 2);
        if (i == 2) {
            ...
            Settings.Global.getInt(this.mContext.getContentResolver(), "oneplus_screen_resolution_auto_adjust", 0);
            if (i2 == 1) {
                this.mIntelligentSwitchResolutionMode.setChecked(true);
                Settings.Global.putInt(this.mContext.getContentResolver(), "oneplus_screen_resolution_adjust", 2);
                Settings.Global.putInt(this.mContext.getContentResolver(), "oneplus_screen_resolution_auto_adjust", 1);
            } else {
                Settings.Global.putInt(this.mContext.getContentResolver(), "oneplus_screen_resolution_adjust", 0);
            }
            if (i2 == 1) {
                OPApplicationUtils.forceStopPackage(this.mAm);
            }
    ...
    public void showWarnigDialog(final int i, int i2) {
        ...
        builder.setPositiveButton(C0017R$string.oneplus_switch_resolution_kill_process_confirm, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Settings.Global.putInt(OPScreenResolutionAdjust.this.mContext.getContentResolver(), "oneplus_screen_resolution_auto_adjust", i == 2 ? 1 : 0);
        ...
        builder.setNegativeButton(C0017R$string.cancel, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
                OPScreenResolutionAdjust.this.cancelDialog();
            }
        });
        AlertDialog create = builder.create();
        this.mWarnDialog = create;
        create.setOnCancelListener(new DialogInterface.OnCancelListener() {
            /* class com.oneplus.settings.OPScreenResolutionAdjust.AnonymousClass3 */
    ...
    private void cancelDialog() {
        boolean z = false;
        int i = Settings.Global.getInt(this.mContext.getContentResolver(), "oneplus_screen_resolution_auto_adjust", 0);
        SwitchPreference switchPreference = this.mIntelligentSwitchResolutionMode;
        if (i == 1) {
            z = true;
        }
    ...
    private boolean isIntelligentSwitchMode() {
        return Settings.Global.getInt(this.mContext.getContentResolver(), "oneplus_screen_resolution_adjust", 2) == 2;
    }
