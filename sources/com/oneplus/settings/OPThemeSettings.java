...
public class OPThemeSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0019R$xml.op_theme_settings) {
        /* class com.oneplus.settings.OPThemeSettings.AnonymousClass1 */

        @Override // com.android.settingslib.search.Indexable$SearchIndexProvider, com.android.settings.search.BaseSearchIndexProvider
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean z) {
            ArrayList arrayList = new ArrayList();
            if (!OPUtils.isSupportNotificationLight() && !OPUtils.isGuestMode()) {
                ...
                searchIndexableRaw.keywords = context.getString(C0017R$string.oneplus_search_keyword_theme_settings_no_notification_light_new);
                arrayList.add(searchIndexableRaw);
            } else if (OPThemeUtils.isSupportCustomeTheme() && !OPUtils.isGuestMode()) {
                ...
                searchIndexableRaw2.keywords = context.getString(C0017R$string.oneplus_search_keyword_theme_settings_mcl_new);
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (!OPUtils.isSupportNotificationLight() || OPThemeUtils.isSupportCustomeTheme() || OPUtils.isGuestMode()) {
