...
public class SettingsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (action.equals("com.oem.intent.action.BOOT_COMPLETED")) {
            ...
            if (context != null && ((string = Settings.Global.getString(context.getContentResolver(), "soft_ap_timeout_enabled")) == null || string.length() == 0)) {
                if (OPUtils.isSupportUstMode()) {
                    Settings.Global.putInt(context.getContentResolver(), "soft_ap_timeout_enabled", 2);
                } else {
                    Settings.Global.putInt(context.getContentResolver(), "soft_ap_timeout_enabled", 1);
                }
            }
