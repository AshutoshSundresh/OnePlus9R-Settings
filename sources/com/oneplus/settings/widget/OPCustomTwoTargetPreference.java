...
public class OPCustomTwoTargetPreference extends TwoTargetPreference implements View.OnClickListener {
    ...
    public interface OnGearClickListener {
        void onGearClick(OPCustomTwoTargetPreference oPCustomTwoTargetPreference);
    }

    public interface OnRadioButtonClickListener {
        void onRadioButtonClick(OPCustomTwoTargetPreference oPCustomTwoTargetPreference);
    }

    public OPCustomTwoTargetPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        setLayoutResource(C0012R$layout.op_preference_two_target_radio);
    }

    public OPCustomTwoTargetPreference(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        setLayoutResource(C0012R$layout.op_preference_two_target_radio);
    }

    public OPCustomTwoTargetPreference(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        setLayoutResource(C0012R$layout.op_preference_two_target_radio);
    }

    public OPCustomTwoTargetPreference(Context context) {
        super(context);
        setLayoutResource(C0012R$layout.op_preference_two_target_radio);
    }
