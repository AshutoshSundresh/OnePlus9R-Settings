...
public class OPRegulatoryInfoDisplayActivity extends BaseActivity {
    ...
    private boolean isShowCanadaInfo() {
        return Build.MODEL.equals(getString(C0017R$string.oneplus_model_avicii_for_us)) || Build.MODEL.equals(getString(C0017R$string.oneplus_model_kebab_for_01)) || Build.MODEL.equals(getString(C0017R$string.oneplus_model_19811_for_us)) || Build.MODEL.equals(getString(C0017R$string.oneplus_model_19821_for_us)) || Build.MODEL.equalsIgnoreCase("GM1917") || Build.MODEL.equalsIgnoreCase("GM1905") || Build.MODEL.equalsIgnoreCase("HD1905") || Build.MODEL.equals("ONEPLUS A6003") || Build.MODEL.equals("ONEPLUS A6013") || Build.MODEL.equals("ONEPLUS A5000") || Build.MODEL.equals("ONEPLUS A5010") || Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_02)) || Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_06));
    }
    ...
    private void showCanadaInfo() {
        ...
        if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_19811_for_us)) || Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_02)) || Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_06))) {
            this.mRegulatoryInfoCanadaCan.setText(C0017R$string.oneplus_regulatory_info_canada_can_cnr);
        }
        setCanadaIC();
    }

    private boolean isShowIndiaSar() {
        return Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_avicii_for_in)) || Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_kebab_for_03)) || Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_19811_for_in)) || Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_19821_for_in)) || Build.MODEL.equalsIgnoreCase("GM1911") || Build.MODEL.equalsIgnoreCase("GM1901") || Build.MODEL.equalsIgnoreCase("HD1901") || Build.MODEL.equalsIgnoreCase("HD1911") || Build.MODEL.equalsIgnoreCase("ONEPLUS A6000") || Build.MODEL.equalsIgnoreCase("ONEPLUS A6010") || Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_breeze_for_04)) || Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_breeze_for_07)) || Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_breeze_for_08));
    }
    ...
    private void showIndiaSar() {
        ...
        this.mIndiaSarInfo.setVisibility(0);
        String str2 = "XXX";
        if (Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_breeze_for_07))) {
            str2 = getString(C0017R$string.oneplus_model_breeze_for_07_in_head);
            str = getString(C0017R$string.oneplus_model_breeze_for_07_in_body);
        } else if (Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_breeze_for_04))) {
            str2 = getString(C0017R$string.oneplus_model_breeze_for_04_in_head);
            str = getString(C0017R$string.oneplus_model_breeze_for_04_in_body);
        } else if (Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_breeze_for_08))) {
            str2 = getString(C0017R$string.oneplus_model_breeze_for_08_in_head);
            str = getString(C0017R$string.oneplus_model_breeze_for_08_in_body);
        } else if (Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_avicii_for_in))) {
            str2 = getString(C0017R$string.oneplus_avicii_in_head);
            str = getString(C0017R$string.oneplus_avicii_in_body);
        } else if (Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_kebab_for_03))) {
            str2 = getString(C0017R$string.oneplus_kebab_in_head);
            str = getString(C0017R$string.oneplus_kebab_in_body);
        } else if (Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_19811_for_in))) {
    ...
    private void setCanadaIC() {
        ...
        if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_avicii_for_us))) {
            string = string + getString(C0017R$string.oneplus_avicii_canada_ic);
        } else if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_02))) {
            string = string + getString(C0017R$string.oneplus_model_breeze_for_02_canada_ic);
        } else if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_06))) {
            string = string + getString(C0017R$string.oneplus_model_breeze_for_06_canada_ic);
        } else if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_kebab_for_01))) {
            string = string + getString(C0017R$string.oneplus_kebab_canada_ic);
        } else if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_19811_for_us))) {
    ...
    private String getUSFccID() {
        if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_avicii_for_us))) {
            return getString(C0017R$string.oneplus_avicii_us_fcc_id);
        }
        if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_kebab_for_01))) {
            return getString(C0017R$string.oneplus_model_kebab_for_01_fcc_id);
        }
        if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_kebabt))) {
            return getString(C0017R$string.oneplus_kebabt_fcc_id);
        }
        ...
        if (Build.MODEL.equals("IN2017")) {
            return getString(C0017R$string.oneplus_19855_tmo_fcc_id);
        }
        if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_01))) {
            return getString(C0017R$string.oneplus_model_breeze_for_01_fcc_id);
        }
        if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_02))) {
            return getString(C0017R$string.oneplus_model_breeze_for_02_fcc_id);
        }
        if (Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_05))) {
            return getString(C0017R$string.oneplus_model_breeze_for_05_fcc_id);
        }
        return Build.MODEL.equals(getString(C0017R$string.oneplus_model_breeze_for_06)) ? getString(C0017R$string.oneplus_model_breeze_for_06_fcc_id) : "none";
    }
