...
public class OPDefaultAssistPreferenceController extends BasePreferenceController implements LifecycleObserver, OnResume, OnPause {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        oPCustomTwoTargetPreference.setOnGearClickListener(new OPCustomTwoTargetPreference.OnGearClickListener() {
            /* class com.oneplus.settings.$$Lambda$OPDefaultAssistPreferenceController$KWKnrrDcn7SAkG4n3ugI9yE2M */
            ...
            public final void onGearClick(OPCustomTwoTargetPreference oPCustomTwoTargetPreference) {
                OPDefaultAssistPreferenceController.this.lambda$displayPreference$0$OPDefaultAssistPreferenceController(oPCustomTwoTargetPreference);
            }
        });
        this.mPreference.setOnRadioButtonClickListener(new OPCustomTwoTargetPreference.OnRadioButtonClickListener() {
            /* class com.oneplus.settings.$$Lambda$OPDefaultAssistPreferenceController$EwxuNvCBke1qXrvlZH54u4VRWNM */
            ...
            public final void onRadioButtonClick(OPCustomTwoTargetPreference oPCustomTwoTargetPreference) {
                OPDefaultAssistPreferenceController.this.lambda$displayPreference$1$OPDefaultAssistPreferenceController(oPCustomTwoTargetPreference);
            }
        });
    ...
    public /* synthetic */ void lambda$displayPreference$0$OPDefaultAssistPreferenceController(OPCustomTwoTargetPreference oPCustomTwoTargetPreference) {
    ...
    public /* synthetic */ void lambda$displayPreference$1$OPDefaultAssistPreferenceController(OPCustomTwoTargetPreference oPCustomTwoTargetPreference) {
    ...
    private void noAssistantAppDialog() {
        ...
        AnonymousClass2 r1 = new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialogInterface) {
                OPCustomTwoTargetPreference oPCustomTwoTargetPreference = OPDefaultAssistPreferenceController.this.mPreference;
                boolean z = false;
