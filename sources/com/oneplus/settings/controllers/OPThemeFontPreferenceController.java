        ...
        if (opGetFontIDsForUser != null) {
            for (Integer num : opGetFontIDsForUser) {
                if (num.intValue() == currentFont) {
                    ...
                    String otherPackageString = OPUtils.getOtherPackageString(resources, OP_PACKAGE, OP_FONT_NAME + num);
                    Log.d("OPThemeFontPreferenceController", " fontId:" + num + " currentFont:" + currentFont + " fontName:" + ((Object) otherPackageString));
                    return otherPackageString;
                }
            }
        }
