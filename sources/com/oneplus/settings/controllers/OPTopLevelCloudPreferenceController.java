...
public class OPTopLevelCloudPreferenceController extends BasePreferenceController implements LifecycleObserver {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (OPUtils.isAppExist(this.mContext, "com.heytap.cloud")) {
            findPreference.setTitle(getAppName(this.mContext, "com.heytap.cloud"));
        } else if (OPUtils.isAppExist(this.mContext, "com.oneplus.cloud")) {
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        try {
            if (OPUtils.isAppExist(this.mContext, "com.heytap.cloud")) {
                Intent intent = new Intent("intent.action.ocloud.MAIN");
                ...
                Intent intent2 = new Intent("android.intent.action.ONEPLUSCLOUD");
                intent2.setClassName("com.oneplus.cloud", "com.oneplus.cloud.activity.OPMainActivity");
