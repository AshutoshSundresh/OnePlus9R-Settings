...
public class OPGestureSettings extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        /* class com.oneplus.settings.OPGestureSettings.AnonymousClass2 */
        boolean mIsPrimary;
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (OPUtils.isSupportGoogleCommSuit()) {
    ...
    public void onResume() {
        ...
        initGestureSummary();
        boolean z = false;
        this.mOneHandedMode.setChecked(Settings.System.getIntForUser(this.mContext.getContentResolver(), "op_one_hand_mode_setting", 0, -2) == 1);
