...
public class OPAuthenticationInformationSettings extends BaseActivity {
    ...
    private void setCmiitID() {
        ...
        } else if (Build.MODEL.equalsIgnoreCase(getString(C0017R$string.oneplus_model_kebab_for_02))) {
            this.mCmiitIdView.setText(String.format(string, getString(C0017R$string.oneplus_model_kebab_for_02_cmittid)));
        } else {
