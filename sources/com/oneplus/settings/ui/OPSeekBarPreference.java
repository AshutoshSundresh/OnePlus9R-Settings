...
public class OPSeekBarPreference extends Preference {
    ...
    private void initSeekBar(PreferenceViewHolder preferenceViewHolder) {
        OPVerticalSeekBar oPVerticalSeekBar = (OPVerticalSeekBar) preferenceViewHolder.findViewById(C0010R$id.screen_color_mode_seekbar);
        this.mSeekBar = oPVerticalSeekBar;
        oPVerticalSeekBar.setMax(100);
        this.mSeekBar.setMarkerPosition(50);
        this.mSeekBar.setProgress(Settings.System.getInt(this.mContext.getContentResolver(), "oem_screen_better_value", 50));
