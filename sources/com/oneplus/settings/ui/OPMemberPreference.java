...
public class OPMemberPreference extends Preference {
    ...
    private void getMemberInfo() {
        ...
        if (isIndia()) {
            str = this.mContext.getString(C0017R$string.op_member_description);
        } else if (OPUtils.isH2()) {
            str = this.mContext.getString(C0017R$string.op_china_member_description);
        } else {
            str = this.mContext.getString(C0017R$string.op_oxygen_member_description);
        }
        String string2 = defaultSharedPreferences.getString("member_title", string);
        String string3 = defaultSharedPreferences.getString("member_avatar", "");
        String string4 = defaultSharedPreferences.getString("token", "");
        this.mTvContent.setText(defaultSharedPreferences.getString("member_content", str));
        this.mTvTitle.setText(string2);
        setAvatar(string3, string2, string4);
