        ...
        for (int i8 = 0; i8 < getChildCount(); i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (isRtlMode()) {
                    ...
                    childAt.layout(width - childAt.getMeasuredWidth(), i5, width, measuredHeight);
                    paddingRight += marginLayoutParams.rightMargin + childAt.getMeasuredWidth() + marginLayoutParams.leftMargin;
                } else {
                    int i9 = marginLayoutParams.leftMargin + paddingLeft;
                    childAt.layout(i9, i5, childAt.getMeasuredWidth() + i9, measuredHeight);
