...
public class OPScreenColorModeSummary extends RestrictedPreference {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (Settings.System.getInt(this.mContext.getContentResolver(), OPReadingModeTurnOnPreferenceController.READING_MODE_STATUS_MANUAL, 0) != 0) {
            z = true;
        }
        if (!z2) {
    ...
    public void setTextSummary(CharSequence charSequence) {
