...
public class OPCustomNotificationAnimVideoPreference extends Preference {
    ...
    private int getCustomAnimationId(int i) {
        ...
        return C0016R$raw.op_custom_horizon_light_red1_anim;
    }
    ...
    private void initStyleAnimViews() {
        ...
        OPCustomItemEntity oPCustomItemEntity6 = new OPCustomItemEntity(this.mContext.getString(C0017R$string.aod_horizon_light_effect_red), C0008R$drawable.op_custom_horizon_light_red1, 20);
