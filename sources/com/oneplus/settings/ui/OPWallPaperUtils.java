...
public class OPWallPaperUtils {
    ...
    public static boolean isOnePlusLiveWallpaper(Context context) {
        ...
        return (OPUtils.isEightSeriesProducts() || OPUtils.isAviciiProducts() || OPUtils.isLProducts()) ? wallpaperInfo != null && wallpaperInfo.getComponent().flattenToString().contains(ONEPLUS_LIVE_WALLPAPER.flattenToString()) : wallpaperInfo != null && wallpaperInfo.getComponent().equals(ONEPLUS_LIVE_WALLPAPER);
    }
