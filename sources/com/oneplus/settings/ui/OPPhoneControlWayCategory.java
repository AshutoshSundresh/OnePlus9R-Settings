...
public class OPPhoneControlWayCategory extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mPageIndicator = (PageIndicatorView) preferenceViewHolder.findViewById(C0010R$id.gesture_page_indicator);
        ...
        this.mPageIndicator.setPosition(this.mViewPager.getCurrentItem());
    ...
    public class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int i) {
            ...
            OPPhoneControlWayCategory.this.mPageIndicator.setPosition(i);
        }

        @Override // androidx.viewpager.widget.ViewPager.OnPageChangeListener
        public void onPageScrolled(int i, float f, int i2) {
            OPPhoneControlWayCategory.this.mPageIndicator.setProgress(i, f);
        }
    }
}
