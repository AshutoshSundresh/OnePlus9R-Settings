...
public class OPCustomFingeprintAnimVideoPreference extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (this.mAnimationAvailable) {
            ...
            ImageView imageView3 = (ImageView) preferenceViewHolder.findViewById(C0010R$id.bottom_icon_image);
            if (OPThemeUtils.isSupportREDTheme() && OPThemeUtils.isCurrentREDTheme(getContext())) {
                imageView3.setBackgroundResource(C0008R$drawable.op_ic_custom_finger_logo_bg_red);
            }
    ...
    private int getCustomAnimationId(int i) {
        ...
        return C0016R$raw.op_custom_fingerprint_anim_red;
    }
    ...
    private void initStyleAnimViews() {
        ...
        OPCustomItemEntity oPCustomItemEntity3 = OPThemeUtils.isSupportREDTheme() ? new OPCustomItemEntity(this.mContext.getString(C0017R$string.oneplus_select_fingerprint_animation_effect_red), C0008R$drawable.op_img_fod_red, 11) : null;
        OPCustomItemEntity oPCustomItemEntity4 = new OPCustomItemEntity(this.mContext.getString(C0017R$string.oneplus_select_fingerprint_animation_effect_1), C0008R$drawable.op_img_fod_01, 0);
        OPCustomItemEntity oPCustomItemEntity5 = new OPCustomItemEntity(this.mContext.getString(C0017R$string.oneplus_select_fingerprint_animation_effect_4), C0008R$drawable.op_img_fod_02, 1);
        OPCustomItemEntity oPCustomItemEntity6 = new OPCustomItemEntity(this.mContext.getString(C0017R$string.oneplus_select_fingerprint_animation_effect_3), C0008R$drawable.op_img_fod_03, 2);
        OPCustomItemEntity oPCustomItemEntity7 = new OPCustomItemEntity(this.mContext.getString(C0017R$string.oneplus_select_fingerprint_animation_effect_none), C0008R$drawable.op_img_fod_04, 9);
        if (OPUtils.isEightSeriesProducts() || OPUtils.isLProducts() || OPUtils.isAviciiProducts()) {
        ...
        if (OPThemeUtils.isSupportREDTheme() && OPThemeUtils.isCurrentREDTheme(getContext())) {
            oPCustomItemEntity4.resId = C0008R$drawable.op_red_img_fod_01;
            oPCustomItemEntity5.resId = C0008R$drawable.op_red_img_fod_02;
            oPCustomItemEntity6.resId = C0008R$drawable.op_red_img_fod_03;
            oPCustomItemEntity7.resId = C0008R$drawable.op_red_img_fod_04;
            if (oPCustomItemEntity != null) {
                oPCustomItemEntity.resId = C0008R$drawable.op_red_img_fod_06;
            }
            if (oPCustomItemEntity3 != null) {
                oPCustomItemEntity3.resId = C0008R$drawable.op_red_img_fod_red;
            }
        }
        ...
        if (intForUser == 1) {
            ...
            if (intForUser != 4) {
                if (intForUser == 9) {
                    oPCustomItemEntity7.selected = true;
                } else if (intForUser != 11) {
                    oPCustomItemEntity4.selected = true;
                } else if (oPCustomItemEntity3 != null) {
        ...
        this.mAnims.add(oPCustomItemEntity7);
    }
