    ...
    public void onCreate(Bundle bundle) {
        ...
        if (OPUtils.isBlackModeOn(SettingsBaseApplication.mApplication.getContentResolver())) {
            if (OPUtils.isAviciiProducts()) {
                this.mShowNotch.setImageResource(C0008R$drawable.op_front_camera_mode_guide_dark_acivii);
            ...
            if (OPUtils.isAviciiProducts()) {
                this.mShowNotch.setImageResource(C0008R$drawable.op_front_camera_mode_guide_light_acivii);
            } else if (OPUtils.isEightSeriesProducts() || OPUtils.isLProducts()) {
