...
public class OPAuthenticationInformationUtils {
    public static boolean isNeedShowAuthenticationInformation(Context context) {
        if (Build.MODEL.equals(context.getString(C0017R$string.oneplus_model_kebab_for_02)) || Build.MODEL.equals(context.getString(C0017R$string.oneplus_oneplus_model_18821_for_cn)) || Build.MODEL.equals(context.getString(C0017R$string.oneplus_oneplus_model_18857_for_cn))) {
            return true;
        }
