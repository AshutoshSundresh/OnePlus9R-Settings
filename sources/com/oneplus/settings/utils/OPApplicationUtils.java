...
public class OPApplicationUtils {
    ...
    public static boolean isInNotKillAppWhiteList(String str) {
        List<String> asList = Arrays.asList(SettingsBaseApplication.mApplication.getResources().getStringArray(C0003R$array.oneplus_not_kill_app_white_list));
        if (asList == null) {
            return false;
        }
        for (String str2 : asList) {
            Log.d("OPApplicationUtils", "isInNotKillAppWhiteList eachPkgName:" + str2 + " pkgName:" + str);
