...
public class OPReadingMode extends DashboardFragment implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        OPFooterPreference oPFooterPreference = (OPFooterPreference) findPreference("oneplus_reading_mode_footer");
        this.mFooterPreference = oPFooterPreference;
        oPFooterPreference.setTitle(C0017R$string.oneplus_reading_mode_auto_summary);
    }
