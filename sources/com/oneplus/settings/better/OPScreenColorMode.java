...
import com.oneplus.settings.ui.OPChrominanceSeekBarPreference;
...
public class OPScreenColorMode extends SettingsPreferenceFragment implements Preference.OnPreferenceClickListener, RadioButtonPreference.OnClickListener, OPSeekBarPreference.OPColorModeSeekBarChangeListener, OPChrominanceSeekBarPreference.OPChrominanceSeekBarChangeListener {
    ...
    private ContentObserver mAccessibilityDisplayDaltonizerAndInversionContentObserver = new ContentObserver(new Handler()) {
        ...
        final Uri accessibilityDisplayGrayscaleEnabledUri = Settings.System.getUriFor("accessibility_display_grayscale_enabled");
        ...
        public void onChange(boolean z, Uri uri) {
            ...
            if (this.accessibilityDisplayDaltonizerEnabledUri.equals(uri) || this.accessibilityDisplayInversionEnabledUri.equals(uri) || this.accessibilityDisplayGrayscaleEnabledUri.equals(uri)) {
                boolean z2 = false;
                ...
                boolean z5 = Settings.System.getInt(OPScreenColorMode.this.getContentResolver(), "accessibility_display_grayscale_enabled", 1) == 0;
                OPScreenColorMode.this.mScreenColorModeDefaultSettings.setEnabled(!z3 && !z4 && !z5);
                OPScreenColorMode.this.mScreenColorModeBasicSettings.setEnabled(!z3 && !z4 && !z5);
                OPScreenColorMode.this.mScreenColorModeDefinedSettings.setEnabled(!z3 && !z4 && !z5);
                OPScreenColorMode.this.mScreenColorModeDciP3Settings.setEnabled(!z3 && !z4 && !z5);
                OPScreenColorMode.this.mScreenColorModeAdaptiveModelSettings.setEnabled(!z3 && !z4 && !z5);
                OPScreenColorMode.this.mScreenColorModeSoftSettings.setEnabled(!z3 && !z4 && !z5);
                OPScreenColorMode.this.mScreenColorModeAutoSettings.setEnabled(!z3 && !z4 && !z5);
                OPScreenColorMode.this.mScreenColorModeCustomPreferenceCategory.setEnabled(!z3 && !z4 && !z5);
    ...
    private OPChrominanceSeekBarPreference mChrominanceSeekBarPreference;
    private boolean mChrominanceVibratorFlag = true;
    ...
    private boolean mProgressVibratorFlag = true;
    ...
    private int mVibratorSceneId = 1003;
    ...
    @Override // com.oneplus.settings.ui.OPChrominanceSeekBarPreference.OPChrominanceSeekBarChangeListener
    public void onChrominanceStartTrackingTouch(SeekBar seekBar) {
    }

    @Override // com.oneplus.settings.ui.OPChrominanceSeekBarPreference.OPChrominanceSeekBarChangeListener
    public void onChrominanceStopTrackingTouch(SeekBar seekBar) {
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mContext.getPackageManager().hasSystemFeature("oem.read_mode.support");
        ...
        OPChrominanceSeekBarPreference oPChrominanceSeekBarPreference = (OPChrominanceSeekBarPreference) findPreference("chrominance_seekbar");
        this.mChrominanceSeekBarPreference = oPChrominanceSeekBarPreference;
        oPChrominanceSeekBarPreference.setOPChrominanceSeekBarChangeListener(this);
        boolean z = false;
        if (!OPUtils.isSupportColorToneAdjustment()) {
            this.mChrominanceSeekBarPreference.setVisible(false);
        }
    ...
    public void onStop() {
        ...
        int i = Settings.System.getInt(getContentResolver(), "oem_screen_better_value", 50);
    ...
    private void updatePreferenceStatus() {
        ...
        this.mChrominanceSeekBarPreference.setEnabled(z);
    ...
    public void onResume() {
        ...
        this.mScreenColorModeValue = Settings.System.getInt(getContentResolver(), "oem_screen_better_value", 50);
    ...
    private void updateRadioButtons(int i) {
        if (1 == i) {
            ...
            removePreference("chrominance_seekbar");
            ...
            getPreferenceScreen().addPreference(this.mChrominanceSeekBarPreference);
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
        if (z) {
            ...
            if (i != 50 && i > 47 && i < 53) {
                ...
                if (this.mProgressVibratorFlag) {
                    doVibrate();
                    this.mProgressVibratorFlag = false;
                }
                i = 50;
            } else if (i == 50) {
                doVibrate();
            } else {
                this.mProgressVibratorFlag = true;
            }
    ...
    @Override // com.oneplus.settings.ui.OPChrominanceSeekBarPreference.OPChrominanceSeekBarChangeListener
    public void onChrominanceProgressChanged(SeekBar seekBar, int i, boolean z) {
        if (z) {
            if (i != 50 && i > 47 && i < 53) {
                seekBar.setProgress(50);
                if (this.mChrominanceVibratorFlag) {
                    doVibrate();
                    this.mChrominanceVibratorFlag = false;
                }
                i = 50;
            } else if (i == 50) {
                doVibrate();
            } else {
                this.mChrominanceVibratorFlag = true;
            }
            Settings.System.putInt(getContentResolver(), "oem_screen_chrominance_value", i);
        }
    }
    ...
    public void doVibrate() {
        if (AACHapticUtils.getInstance().supportRichTap() && this.mVibrator != null && VibratorSceneUtils.systemVibrateEnabled(this.mContext)) {
