...
public class OPNightMode extends SettingsPreferenceFragment implements NightDisplayListener.Callback, Preference.OnPreferenceChangeListener, OPNightModeLevelPreferenceCategory.OPNightModeLevelPreferenceChangeListener {
    ...
    @Override // com.oneplus.settings.ui.OPNightModeLevelPreferenceCategory.OPNightModeLevelPreferenceChangeListener
    public void onSaturationStartTrackingTouch(int i) {
    }

    @Override // com.oneplus.settings.ui.OPNightModeLevelPreferenceCategory.OPNightModeLevelPreferenceChangeListener
    public void onSaturationStopTrackingTouch(int i) {
    }
    ...
    public void onStop() {
        ...
        int intForUser = Settings.System.getIntForUser(getContentResolver(), "oem_nightmode_progress_status", 46, -2);
    ...
    public void onResume() {
        ...
        this.mEnterScreenColorValue = Settings.System.getIntForUser(getContentResolver(), "oem_nightmode_progress_status", 46, -2);
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        if ("night_mode_enabled".equals(key)) {
            ...
            int saturationProgress = this.mNightModeLevelPreferenceCategory.getSaturationProgress();
            if (booleanValue) {
                ...
                if (OPUtils.isSupportColorSaturationAdjustment()) {
                    saveSaturationProgress(saturationProgress);
                }
            } else {
    ...
    @Override // com.oneplus.settings.ui.OPNightModeLevelPreferenceCategory.OPNightModeLevelPreferenceChangeListener
    public void onColorProgressChanged(SeekBar seekBar, int i, boolean z) {
        if (z) {
            if (i != 46 && i > 43 && i < 49) {
    ...
    @Override // com.oneplus.settings.ui.OPNightModeLevelPreferenceCategory.OPNightModeLevelPreferenceChangeListener
    public void onSaturationProgressChanged(SeekBar seekBar, int i, boolean z) {
        if (z) {
            SeekBarVibratorHelper.getInstance().doSeekBarVibrate(seekBar, i);
            saveSaturationProgress(i);
        }
    }

    private void saveSaturationProgress(int i) {
        Settings.System.putIntForUser(getContentResolver(), "oem_screen_saturation_value", i, -2);
    }
