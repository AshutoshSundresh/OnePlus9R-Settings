...
public class DefaultAppLogic {
    ...
    public int getDefaultAppPosition(String str, List<String> list, String str2) {
        Log.d("DefaultAppLogic", "getDefaultAppPosition defaultPackageName:" + str2);
        int i = 0;
        while (true) {
            if (i >= list.size()) {
                i = -1;
            ...
            Log.d("DefaultAppLogic", "getDefaultAppPosition packageName:" + str3);
            if (str3.equals(str2)) {
                break;
            }
            i++;
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            if (list.get(i2).equals("com.heytap.music")) {
                return i2;
            }
        }
        return i;
