...
public class OPChargingStationSettings extends DashboardFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((SettingsActivity) activity).getSwitchBar().hide();
        SwitchPreference switchPreference = (SwitchPreference) findPreference("op_charging_station_mute_notification");
        MasterSwitchPreference masterSwitchPreference = (MasterSwitchPreference) findPreference("op_charging_station_feature");
        MasterSwitchController masterSwitchController = masterSwitchPreference != null ? new MasterSwitchController(masterSwitchPreference) : null;
        if (switchPreference != null) {
            switchPreference.setOnPreferenceChangeListener(this);
            updateMuteDescription(switchPreference);
        }
        LifecycleObserver oPChargingStationSettingsController = new OPChargingStationSettingsController(activity, masterSwitchController, switchPreference);
