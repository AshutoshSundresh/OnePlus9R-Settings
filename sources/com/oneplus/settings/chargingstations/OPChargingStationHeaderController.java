...
public class OPChargingStationHeaderController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop, OPChargingStationUtils.ILocationUpdate {
    ...
    private ContentObserver mObserver = new ContentObserver(new Handler()) {
        /* class com.oneplus.settings.chargingstations.OPChargingStationHeaderController.AnonymousClass2 */
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        LottieAnimationView lottieAnimationView = (LottieAnimationView) layoutPreference.findViewById(C0010R$id.animation_view);
        final LottieAnimationView lottieAnimationView2 = (LottieAnimationView) layoutPreference.findViewById(C0010R$id.animation_view_dots);
        lottieAnimationView.playAnimation();
        lottieAnimationView.addAnimatorListener(new Animator.AnimatorListener(this) {
