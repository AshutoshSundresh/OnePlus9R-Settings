...
public class OPButtonCustomSettings extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    static boolean isSwipeUpEnabled(Context context) {
        if (!isEdgeToEdgeEnabled(context) && 1 == context.getResources().getInteger(17694862)) {
            return true;
        }
        return false;
    }
    ...
    private void initListViewPrefs() {
        ...
        this.mHomeLongPressAction = initActionList("hardware_keys_home_long_press", Settings.System.getInt(contentResolver, "key_home_long_press_action", getActivity().getResources().getInteger(17694836)));
        this.mHomeDoubleTapAction = initActionList("hardware_keys_home_double_tap", Settings.System.getInt(contentResolver, "key_home_double_tap_action", getActivity().getResources().getInteger(17694811)));
