...
public class AppBgOptimizeBridge extends AppStateBaseBridge {
    ...
    public static final ApplicationsState.AppFilter FILTER_APP_BG_NOT_OPTIMIZE = new ApplicationsState.AppFilter() {
        ...
        public boolean filterApp(ApplicationsState.AppEntry appEntry) {
            Object obj;
            if (AppBgOptimizeBridge.VZW_APPS_SHOWN_DISABLED.contains(appEntry.info.packageName) && ProductUtils.isUsvMode()) {
                return true;
            }
            if (appEntry == null || (obj = appEntry.extraInfo) == null || !(obj instanceof AppControlMode) || UserHandle.getUserId(appEntry.info.uid) == 999) {
                return false;
            }
            return 1 == ((AppControlMode) appEntry.extraInfo).value;
        }
    };
    ...
    public static void loadDisabledApps() {
        try {
            VZW_APPS_SHOWN_DISABLED = new HashSet<>(Arrays.asList(IDeviceIdleController.Stub.asInterface(ServiceManager.getService("deviceidle")).getSystemPowerWhitelist()));
    ...
    static {
        String[] strArr = {"com.oneplus.card", "com.oneplus.cloud", "com.oneplus.appupgrader", "net.oneplus.launcher", "com.oneplus.dirac.simplemanager", "com.oneplus.soundrecorder", "com.oneplus.sound.tuner", "com.oneplus.soundrecorder", "com.android.dialer", "com.oneplus.mms", "com.oneplus.opbackup"};
