...
public class OPColorPickerActivity extends BaseActivity implements View.OnClickListener, ColorPickerView.OnColorChangedListener, OnPressListener {
    ...
    private void refreshUI(String str) {
        ...
        if (imageView != null) {
            if (this.mSelectIndex == 0) {
                imageView.setImageResource(C0008R$drawable.op_default_accent_color_preview_bg);
            } else {
                imageView.setImageResource(C0008R$drawable.op_custom_accent_color_preview_upper_layer);
            }
            if (this.mSelectIndex != 0 && this.mPreviewImg.getDrawable() != null) {
        ...
        for (int i = 0; i < strArr.length; i++) {
            ...
            this.mViews[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!strArr[intValue].equals(OPColorPickerActivity.this.mCurrentTempColor) || OPColorPickerActivity.this.mIsCustomColor) {
    ...
    public void init() {
        ...
        if (Settings.System.getInt(getContentResolver(), "oem_white_mode_accent_color_index", -2) == -1 || Settings.System.getInt(getContentResolver(), "oem_black_mode_accent_color_index", -2) == -1) {
            this.mSelectIndex = -1;
        }
        int i2 = this.mSelectIndex;
