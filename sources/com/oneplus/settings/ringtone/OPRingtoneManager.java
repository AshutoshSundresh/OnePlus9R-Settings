...
public class OPRingtoneManager {
    ...
    private Cursor getInternalRingtones() {
        ...
        return new ExternalRingtonesCursorWrapper(query(MediaStore.Audio.Media.INTERNAL_CONTENT_URI, INTERNAL_COLUMNS, constructBooleanTrueWhereClause(this.mFilterColumns), null, OPUtils.isSupportSortByTrack() ? "track" : "title_key"), MediaStore.Audio.Media.INTERNAL_CONTENT_URI);
    }
    ...
    private static String[] constructWhereClauseWithOP1(int i) {
        ...
        String str3 = OPThemeUtils.isSupportCustomeTheme() ? "/mnt/vendor/op1/" : "/op1/";
        if (i != 2) {
            if (i == 4) {
                str = "alarms/%";
            } else if (i != 8) {
            ...
            return new String[]{str2 + str, str3 + str};
        }
        str = "notifications/%";
        return new String[]{str2 + str, str3 + str};
    }
    ...
    public static String getDefaultRingtoneFileName(Context context, String str) {
    ...
    public static Uri updateRingtoneForInternal(Context context, Uri uri, Cursor cursor, int i, int i2) {
        ...
        String str = OPThemeUtils.isSupportCustomeTheme() ? "/mnt/vendor/op1/" : "/op1/";
        if (OPUtils.isSupportSystemProductionRingtone()) {
            if (string == null || string.startsWith("/system/product/media/audio/") || string.startsWith(str)) {
                return uri;
            }
        } else if (string == null || string.startsWith("/product/media/audio/") || string.startsWith(str)) {
            return uri;
        }
