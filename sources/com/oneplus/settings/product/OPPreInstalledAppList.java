...
public class OPPreInstalledAppList extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (OPUtils.isSupportC88()) {
            sOneplusH2PreIinstalledAppsName = getContext().getResources().getStringArray(C0003R$array.pre_installed_app_name_kebab_cbb);
            sOneplusH2PreIinstalledAppsCompany = getContext().getResources().getStringArray(C0003R$array.pre_installed_app_company_kebab_cbb);
            sOneplusH2PreIinstalledAppsFunction = getContext().getResources().getStringArray(C0003R$array.pre_installed_app_function_kebab_cbb);
        } else if (OPUtils.isEightSeriesProducts() && !OPBuildModelUtils.is19811() && !OPBuildModelUtils.is19821()) {
