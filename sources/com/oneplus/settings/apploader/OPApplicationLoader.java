...
public class OPApplicationLoader {
        ...
        try {
            ...
            if (!list.isEmpty()) {
                for (ResolveInfo resolveInfo : list) {
                    ...
                    if (!packageExcludeFilter(str2)) {
                        int i = resolveInfo.activityInfo.applicationInfo.uid;
                        if (this.mAppType != 1001 || !"com.google.android.documentsui".equals(str2) || UserHandle.getUserId(i) != 999) {
                            Map<String, String> map = this.mSelectedAppMap;
                            StringBuilder sb = new StringBuilder();
                            sb.append(i);
                            sb.append(str2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x00d6, code lost:
        if ("com.amazon.avod.thirdpartyclient".equals(r8) == false) goto L_0x0104;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:69:0x0101, code lost:
        if ("com.oneplus.gamespace".equals(r8) == false) goto L_0x0104;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
