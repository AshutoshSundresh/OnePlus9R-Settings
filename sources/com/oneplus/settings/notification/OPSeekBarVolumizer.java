...
public class OPSeekBarVolumizer implements SeekBar.OnSeekBarChangeListener, Handler.Callback {
    ...
    public boolean handleMessage(Message message) {
        ...
        } else if (this.mCurrentStreamType == this.mStreamType) {
            Log.d("OPSeekBarVolumizer", "MSG_SET_STREAM_VOLUME mMuted = " + this.mMuted + " mLastProgress : " + this.mLastProgress);
    ...
    private void postSetVolume(int i) {
        Log.d("OPSeekBarVolumizer", "postSetVolume progress: " + i);
        Handler handler = this.mHandler;
        if (handler != null) {
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        Log.d("OPSeekBarVolumizer", "onStopTrackingTouch");
