...
public class OPLabFeatureDetailActivity extends BaseActivity implements View.OnClickListener, OPRadioButtinGroup.OnRadioGroupClickListener {
    ...
    private void confirmAlertDialog() {
        if (this.mDialog == null) {
            ...
            builder.setPositiveButton(C0017R$string.oneplus_turn_on_feature_ok, this.onClickListener);
            builder.setNegativeButton(C0017R$string.oneplus_turn_on_feature_cancel, this.onClickListener);
    ...
    private void confirmDCDialog() {
        if (this.mDCDialog == null) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage(C0017R$string.op_lab_dc_warn_message);
            builder.setPositiveButton(C0017R$string.op_lab_dc_still_on, this.onClickListener);
            builder.setNegativeButton(C0017R$string.oneplus_turn_on_feature_cancel, this.onClickListener);
            builder.setOnDismissListener(new DialogInterface.OnDismissListener() {
                /* class com.oneplus.settings.laboratory.OPLabFeatureDetailActivity.AnonymousClass3 */
    ...
    public void onClick(View view) {
        ...
        if (id == C0010R$id.op_lab_feature_toggle) {
            if ("oneplus_dc_dimming_value".equalsIgnoreCase(this.mOneplusLabFeatureKey) && OPUtils.isHDProject()) {
            ...
            } else if (!"oneplus_dc_dimming_value".equalsIgnoreCase(this.mOneplusLabFeatureKey) || !OPUtils.isH2()) {
                if (this.mSwitch.isChecked()) {
                    this.mSwitch.setChecked(false);
                } else {
                ...
                if (VibratorSceneUtils.systemVibrateEnabled(this)) {
                    long[] vibratorScenePattern3 = VibratorSceneUtils.getVibratorScenePattern(this, this.mVibrator, 1003);
                    this.mVibratePattern = vibratorScenePattern3;
                    VibratorSceneUtils.vibrateIfNeeded(vibratorScenePattern3, this.mVibrator);
                }
            }
