...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public void onAttachedToWindow() {
        if ((this.mContext.getResources().getDisplayMetrics().heightPixels < 1600 && this.mContext.getResources().getConfiguration().orientation == 1) || (this.mContext.getResources().getDisplayMetrics().widthPixels < 1600 && this.mContext.getResources().getConfiguration().orientation == 2)) {
            getWindow().clearFlags(65792);
            getWindow().addFlags(65792);
            if (this.mAlert.mBottomShow) {
                getWindow().setBackgroundDrawableResource(R$drawable.op_dialog_material_background_bottom);
            } else {
                getWindow().setBackgroundDrawableResource(R$drawable.dialog_background_material);
            }
        ...
        if ((getOwnerActivity() != null || (this.mContext instanceof Activity)) && this.mAlert.mBottomShow) {
            SoftKeyBoardListener.setListener(getOwnerActivity() == null ? (Activity) this.mContext : getOwnerActivity(), new SoftKeyBoardListener.OnSoftKeyBoardChangeListener() {
