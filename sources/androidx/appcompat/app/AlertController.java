    ...
    private void showInBottom(boolean z) {
        ...
        if (z) {
            ...
            if (this.mWindow.findViewById(R$id.parentPanel) != null) {
                ...
                if ((appCompatDialog == null || !(appCompatDialog instanceof EditTextDialog)) && !z2) {
                                    ...
                                    if (view2.findViewById(16908308) instanceof CheckedTextView) {
                                        ...
                                        if (textView != null) {
                                            ...
                                            if (!TextUtils.isEmpty(textView.getText()) && (lineCount > 1 || textView.getText().length() > 50)) {
                                                checkedTextView.setHeight(AlertParams.this.mContext.getResources().getDimensionPixelOffset(R$dimen.oneplus_dialog_subtitle_minHeight_multiline) + (lineCount2 > 1 ? AlertParams.this.mContext.getResources().getDimensionPixelOffset(R$dimen.oneplus_dialog_subtitle_minHeight_noline) : 0));
                                                checkedTextView.setMaxLines(2);
                                                textView.setVisibility(0);
                                            } else if (!TextUtils.isEmpty(textView.getText())) {
                                                checkedTextView.setHeight(AlertParams.this.mContext.getResources().getDimensionPixelOffset(R$dimen.oneplus_dialog_subtitle_minHeight_singleline) + (lineCount2 > 1 ? AlertParams.this.mContext.getResources().getDimensionPixelOffset(R$dimen.oneplus_dialog_subtitle_minHeight_noline) : 0));
                                                checkedTextView.setMaxLines(2);
                                                textView.setVisibility(0);
                                            } else if (TextUtils.isEmpty(textView.getText())) {
                                                checkedTextView.setMinHeight(AlertParams.this.mContext.getResources().getDimensionPixelOffset(R$dimen.oneplus_dialog_subtitle_minHeight_noline) + (lineCount2 > 1 ? AlertParams.this.mContext.getResources().getDimensionPixelOffset(R$dimen.oneplus_dialog_subtitle_minHeight_noline) : 0));
                                                textView.setVisibility(8);
                                            } else {
