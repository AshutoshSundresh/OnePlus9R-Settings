...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, R$styleable.SwitchCompat, i, i2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, R$styleable.SwitchCompat, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, i2);
        }
    ...
    public boolean performClick() {
        if (VibratorSceneUtils.systemVibrateEnabled(getContext())) {
            ...
            VibratorSceneUtils.vibrateIfNeeded(this, vibratorScenePattern, this.mVibrator);
        }
