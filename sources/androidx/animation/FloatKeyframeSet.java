...
public class FloatKeyframeSet extends KeyframeSet<Float> implements Keyframes.FloatKeyframes {
    ...
    public FloatKeyframeSet clone() {
        ...
        for (int i = 0; i < size; i++) {
            floatKeyframeArr[i] = (Keyframe.FloatKeyframe) list.get(i).clone();
        }
    ...
    public float getFloatValue(float f) {
        if (f <= 0.0f) {
            ...
            return typeEvaluator.evaluate(f2, (T) Float.valueOf(floatValue), (T) Float.valueOf(floatValue2)).floatValue();
        } else if (f >= 1.0f) {
            ...
            return typeEvaluator2.evaluate(f3, (T) Float.valueOf(floatValue3), (T) Float.valueOf(floatValue4)).floatValue();
        } else {
            ...
            while (true) {
                ...
                if (i >= i2) {
                    return this.mKeyframes.get(i2 - 1).getValue().floatValue();
                }
                ...
                if (f < floatKeyframe6.getFraction()) {
                    ...
                    return typeEvaluator3.evaluate(fraction5, (T) Float.valueOf(floatValue5), (T) Float.valueOf(floatValue6)).floatValue();
                }
                i++;
