...
public final class AnimatorSet extends Animator implements AnimationHandler.AnimationFrameCallback {
    private static final Comparator<AnimationEvent> EVENT_COMPARATOR = new Comparator<AnimationEvent>() {
        /* class androidx.animation.AnimatorSet.AnonymousClass3 */
    ...
    public AnimatorSet() {
        ...
        this.mDummyListener = new AnimatorListenerAdapter() {
            /* class androidx.animation.AnimatorSet.AnonymousClass1 */
    ...
    @Override // androidx.animation.Animator, androidx.animation.Animator, java.lang.Object
    public AnimatorSet clone() {
        ...
        animatorSet.mDummyListener = new AnimatorListenerAdapter(this) {
            /* class androidx.animation.AnimatorSet.AnonymousClass2 */
